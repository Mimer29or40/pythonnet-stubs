...
class MailMessage(ObjectType, IDisposable):
    ...
    @overload
    def __init__(self, from: StringType, to: StringType): ...
    
    @overload
    def __init__(self, from: StringType, to: StringType, subject: StringType, body: StringType): ...
    
    @overload
    def __init__(self, from: MailAddress, to: MailAddress): ...
...
class SmtpClient(ObjectType, IDisposable):
    ...
    @overload
    def Send(self, from: StringType, recipients: StringType, subject: StringType, body: StringType) -> VoidType: ...
    
    @overload
    def Send(self, message: MailMessage) -> VoidType: ...
    
    @overload
    def SendAsync(self, from: StringType, recipients: StringType, subject: StringType, body: StringType, userToken: ObjectType) -> VoidType: ...
    ...
    @overload
    def SendMailAsync(self, from: StringType, recipients: StringType, subject: StringType, body: StringType) -> Task: ...
