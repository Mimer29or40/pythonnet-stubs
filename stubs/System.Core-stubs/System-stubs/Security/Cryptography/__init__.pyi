...
from abc import ABC
from typing import List, Optional, Protocol, Tuple, Union, overload

from Internal.Cryptography import ICngSymmetricAlgorithm
from Microsoft.Win32.SafeHandles import SafeBCryptAlgorithmHandle, SafeBCryptKeyHandle, SafeCapiKeyHandle, SafeHandleZeroOrMinusOneIsInvalid, SafeNCryptKeyHandle, SafeNCryptProviderHandle, SafeNCryptSecretHandle
from System import ActivationContext, Array, Boolean, Byte, Enum, Exception, IDisposable, IEquatable, Int32, Int64, IntPtr, Nullable, Object, String, SystemException, Type, ValueType, Void
...
from System.Security import ManifestKinds, SecureString, SecurityElement
from System.Security.AccessControl import CryptoKeySecurity
from System.Security.Cryptography import AsnEncodedData, AsnEncodedDataCollection, Oid
...
class CryptographicAttributeObjectCollection(ObjectType, ICollection, IEnumerable):
    ...
    def CopyTo(self, array: ArrayType[CryptographicAttributeObject], index: IntType) -> VoidType: ...
...
class DataProtector(ABC, ObjectType):
    ...
    @staticmethod
    def Create(providerClass: StringType, applicationName: StringType, primaryPurpose: StringType, specificPurposes: ArrayType[StringType]) -> DataProtector: ...
...
class DpapiDataProtector(DataProtector):
    ...
    def __init__(self, appName: StringType, primaryPurpose: StringType, specificPurpose: ArrayType[StringType]): ...
...
class ProtectedData(ABC, ObjectType):
    ...
    @staticmethod
    def Protect(userData: ArrayType[ByteType], optionalEntropy: ArrayType[ByteType], scope: DataProtectionScope) -> ArrayType[ByteType]: ...
    
    @staticmethod
    def Unprotect(encryptedData: ArrayType[ByteType], optionalEntropy: ArrayType[ByteType], scope: DataProtectionScope) -> ArrayType[ByteType]: ...
