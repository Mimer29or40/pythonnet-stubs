...
class LocalAppContextSwitches(ABC, ObjectType):
    ...
    @staticmethod
    @property
    def CmsUseInsecureHashAlgorithms() -> BooleanType: ...
    
    @staticmethod
    @property
    def EnvelopedCmsUseLegacyDefaultAlgorithm() -> BooleanType: ...
    
    @staticmethod
    @property
    def SignedXmlUseLegacyCertificatePrivateKey() -> BooleanType: ...
    
    @staticmethod
    @property
    def XmlUseInsecureHashAlgorithms() -> BooleanType: ...
    
    # ---------- Methods ---------- #
    
    @staticmethod
    def get_CmsUseInsecureHashAlgorithms() -> BooleanType: ...
    
    @staticmethod
    def get_EnvelopedCmsUseLegacyDefaultAlgorithm() -> BooleanType: ...
    
    @staticmethod
    def get_SignedXmlUseLegacyCertificatePrivateKey() -> BooleanType: ...
    
    @staticmethod
    def get_XmlUseInsecureHashAlgorithms() -> BooleanType: ...
