...
class Expression(ABC, ObjectType):
    ...
    @staticmethod
    def MakeTry(type: TypeType, body: Expression, finally: Expression, fault: Expression, handlers: IEnumerable[CatchBlock]) -> TryExpression: ...
    ...
    @staticmethod
    def TryCatchFinally(body: Expression, finally: Expression, handlers: ArrayType[CatchBlock]) -> TryExpression: ...
...
class TryExpression(Expression):
    ...
    def Update(self, body: Expression, handlers: IEnumerable[CatchBlock], finally: Expression, fault: Expression) -> TryExpression: ...
