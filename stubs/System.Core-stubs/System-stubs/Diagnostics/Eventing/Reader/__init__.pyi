...
from System import Array, Boolean, Byte, DateTime, Enum, EventArgs, EventHandler, Exception, Guid, IDisposable, Int16, Int32, Int64, IntPtr, Nullable, Object, String, TimeSpan, Type, UInt16, UInt32, UInt64, Uri, Void
...
class EventLogRecord(EventRecord, IDisposable):
    ...
    def GetPropertyValues(self, propertySelector: EventLogPropertySelector) -> IList[ObjectType]: ...
...
class EventLogSession(ObjectType, IDisposable):
    ...
    @overload
    def __init__(self, server: StringType, domain: StringType, user: StringType, password: SecureString, logOnType: SessionAuthentication): ...
    ...
    @overload
    def ExportLog(self, path: StringType, pathType: PathType, query: StringType, targetFilePath: StringType) -> VoidType: ...
    
    @overload
    def ExportLog(self, path: StringType, pathType: PathType, query: StringType, targetFilePath: StringType, tolerateQueryErrors: BooleanType) -> VoidType: ...
    
    @overload
    def ExportLogAndMessages(self, path: StringType, pathType: PathType, query: StringType, targetFilePath: StringType) -> VoidType: ...
    
    @overload
    def ExportLogAndMessages(self, path: StringType, pathType: PathType, query: StringType, targetFilePath: StringType, tolerateQueryErrors: BooleanType, targetCultureInfo: CultureInfo) -> VoidType: ...
...
class EventLogWatcher(ObjectType, IDisposable):
    ...
    @overload
    def __init__(self, eventQuery: EventLogQuery, bookmark: EventBookmark, readExistingEvents: BooleanType): ...
    ...
    def add_EventRecordWritten(self, value: EventHandler[EventRecordWrittenEventArgs]) -> VoidType: ...
    
    def get_Enabled(self) -> BooleanType: ...
    
    def remove_EventRecordWritten(self, value: EventHandler[EventRecordWrittenEventArgs]) -> VoidType: ...
...
class NativeWrapper(ObjectType):
    ...
    @staticmethod
    def EvtArchiveExportedLog(session: EventLogHandle, logFilePath: StringType, locale: IntType, flags: IntType) -> VoidType: ...
    
    @staticmethod
    def EvtCancel(handle: EventLogHandle) -> VoidType: ...
    
    @staticmethod
    def EvtClearLog(session: EventLogHandle, channelPath: StringType, targetFilePath: StringType, flags: IntType) -> VoidType: ...
    ...
    @staticmethod
    def EvtCreateRenderContext(valuePathsCount: IntType, valuePaths: ArrayType[StringType], flags: EvtRenderContextFlags) -> EventLogHandle: ...
    
    @staticmethod
    def EvtExportLog(session: EventLogHandle, channelPath: StringType, query: StringType, targetFilePath: StringType, flags: IntType) -> VoidType: ...
    
    @staticmethod
    def EvtFormatMessage(handle: EventLogHandle, msgId: UIntType) -> StringType: ...
    
    @staticmethod
    def EvtFormatMessageFormatDescription(handle: EventLogHandle, eventHandle: EventLogHandle, values: ArrayType[StringType]) -> StringType: ...
    
    @staticmethod
    def EvtFormatMessageRenderKeywords(pmHandle: EventLogHandle, eventHandle: EventLogHandle, flag: EvtFormatMessageFlags) -> IEnumerable[StringType]: ...
    
    @staticmethod
    def EvtFormatMessageRenderName(pmHandle: EventLogHandle, eventHandle: EventLogHandle, flag: EvtFormatMessageFlags) -> StringType: ...
    
    @staticmethod
    def EvtGetChannelConfigProperty(handle: EventLogHandle, enumType: EvtChannelConfigPropertyId) -> ObjectType: ...
    
    @staticmethod
    def EvtGetEventInfo(handle: EventLogHandle, enumType: EvtEventPropertyId) -> ObjectType: ...
    
    @staticmethod
    def EvtGetEventMetadataProperty(handle: EventLogHandle, enumType: EvtEventMetadataPropertyId) -> ObjectType: ...
    
    @staticmethod
    def EvtGetLogInfo(handle: EventLogHandle, enumType: EvtLogPropertyId) -> ObjectType: ...
    
    @staticmethod
    def EvtGetObjectArrayProperty(objArrayHandle: EventLogHandle, index: IntType, thePropertyId: IntType) -> ObjectType: ...
    
    @staticmethod
    def EvtGetObjectArraySize(objectArray: EventLogHandle) -> IntType: ...
    
    @staticmethod
    def EvtGetPublisherMetadataProperty(pmHandle: EventLogHandle, thePropertyId: EvtPublisherMetadataPropertyId) -> ObjectType: ...
    
    @staticmethod
    def EvtGetQueryInfo(handle: EventLogHandle, enumType: EvtQueryPropertyId) -> ObjectType: ...
    
    @staticmethod
    def EvtNext(queryHandle: EventLogHandle, eventSize: IntType, events: ArrayType[NIntType], timeout: IntType, flags: IntType, returned: IntType) -> Tuple[BooleanType, IntType]: ...
    
    @staticmethod
    def EvtNextChannelPath(handle: EventLogHandle, finish: BooleanType) -> Tuple[StringType, BooleanType]: ...
    
    @staticmethod
    def EvtNextEventMetadata(eventMetadataEnum: EventLogHandle, flags: IntType) -> EventLogHandle: ...
    
    @staticmethod
    def EvtNextPublisherId(handle: EventLogHandle, finish: BooleanType) -> Tuple[StringType, BooleanType]: ...
    
    @staticmethod
    def EvtOpenChannelConfig(session: EventLogHandle, channelPath: StringType, flags: IntType) -> EventLogHandle: ...
    
    @staticmethod
    def EvtOpenChannelEnum(session: EventLogHandle, flags: IntType) -> EventLogHandle: ...
    
    @staticmethod
    def EvtOpenEventMetadataEnum(ProviderMetadata: EventLogHandle, flags: IntType) -> EventLogHandle: ...
    
    @staticmethod
    def EvtOpenLog(session: EventLogHandle, path: StringType, flags: PathType) -> EventLogHandle: ...
    
    @staticmethod
    def EvtOpenProviderEnum(session: EventLogHandle, flags: IntType) -> EventLogHandle: ...
    
    @staticmethod
    def EvtOpenProviderMetadata(session: EventLogHandle, ProviderId: StringType, logFilePath: StringType, locale: IntType, flags: IntType) -> EventLogHandle: ...
    
    @staticmethod
    def EvtOpenSession(loginClass: EvtLoginClass, login: EvtRpcLogin, timeout: IntType, flags: IntType) -> Tuple[EventLogHandle, EvtRpcLogin]: ...
    
    @staticmethod
    def EvtQuery(session: EventLogHandle, path: StringType, query: StringType, flags: IntType) -> EventLogHandle: ...
    
    @staticmethod
    def EvtRender(context: EventLogHandle, eventHandle: EventLogHandle, flags: EvtRenderFlags, buffer: StringBuilder) -> VoidType: ...
    
    @staticmethod
    def EvtRenderBookmark(eventHandle: EventLogHandle) -> StringType: ...
    
    @staticmethod
    def EvtRenderBufferWithContextSystem(contextHandle: EventLogHandle, eventHandle: EventLogHandle, flag: EvtRenderFlags, systemProperties: SystemProperties, SYSTEM_PROPERTY_COUNT: IntType) -> VoidType: ...
    
    @staticmethod
    def EvtRenderBufferWithContextUserOrValues(contextHandle: EventLogHandle, eventHandle: EventLogHandle) -> IList[ObjectType]: ...
    
    @staticmethod
    def EvtSaveChannelConfig(channelConfig: EventLogHandle, flags: IntType) -> VoidType: ...
    
    @staticmethod
    def EvtSeek(resultSet: EventLogHandle, position: LongType, bookmark: EventLogHandle, timeout: IntType, flags: EvtSeekFlags) -> VoidType: ...
    
    @staticmethod
    def EvtSetChannelConfigProperty(handle: EventLogHandle, enumType: EvtChannelConfigPropertyId, val: ObjectType) -> VoidType: ...
    
    @staticmethod
    def EvtSubscribe(session: EventLogHandle, signalEvent: SafeWaitHandle, path: StringType, query: StringType, bookmark: EventLogHandle, context: NIntType, callback: NIntType, flags: IntType) -> EventLogHandle: ...
...
class ProviderMetadata(ObjectType, IDisposable):
    ...
    @overload
    def __init__(self, providerName: StringType, session: EventLogSession, targetCultureInfo: CultureInfo): ...
...
class ProviderMetadataCachedInformation(ObjectType):
    ...
    def __init__(self, session: EventLogSession, logfile: StringType, maximumCacheSize: IntType): ...
    ...
    @overload
    def GetFormatDescription(self, ProviderName: StringType, eventHandle: EventLogHandle) -> StringType: ...
    
    @overload
    def GetFormatDescription(self, ProviderName: StringType, eventHandle: EventLogHandle, values: ArrayType[StringType]) -> StringType: ...
    
    def GetKeywordDisplayNames(self, ProviderName: StringType, eventHandle: EventLogHandle) -> IEnumerable[StringType]: ...
    
    def GetLevelDisplayName(self, ProviderName: StringType, eventHandle: EventLogHandle) -> StringType: ...
    
    def GetOpcodeDisplayName(self, ProviderName: StringType, eventHandle: EventLogHandle) -> StringType: ...
    
    def GetTaskDisplayName(self, ProviderName: StringType, eventHandle: EventLogHandle) -> StringType: ...
