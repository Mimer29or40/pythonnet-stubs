...
from System.Security.Cryptography import CryptographicAttributeObject
from System.Security.Cryptography import CryptographicAttributeObjectCollection
...
class CmsRecipient(ObjectType):
    ...
    @overload
    def __init__(
        self, recipientIdentifierType: SubjectIdentifierType, certificate: X509Certificate2
    ): ...
...
class CmsRecipientCollection(ObjectType, ICollection, IEnumerable):
    ...
    def __getitem__(self, key: IntType) -> CmsRecipient: ...
    @property
...
class CmsSigner(ObjectType):
    ...
    @overload
    def __init__(
        self, signerIdentifierType: SubjectIdentifierType, certificate: X509Certificate2
    ): ...
...
class EnvelopedCms(ObjectType):
    ...
    @overload
    def __init__(
        self, recipientIdentifierType: SubjectIdentifierType, contentInfo: ContentInfo
    ): ...
    @overload
    ...
    @overload
    def Decrypt(
        self, recipientInfo: RecipientInfo, extraStore: X509Certificate2Collection
    ) -> VoidType: ...
...
class RecipientInfoCollection(ObjectType, ICollection, IEnumerable):
    ...
    @property
    def IsSynchronized(self) -> BooleanType: ...
    def __getitem__(self, key: IntType) -> RecipientInfo: ...
    @property
    def SyncRoot(self) -> ObjectType: ...
...
class SignedCms(ObjectType):
    ...
    @overload
    def CheckSignature(
        self, extraStore: X509Certificate2Collection, verifySignatureOnly: BooleanType
    ) -> VoidType: ...
    @overload
...
class SignerInfoCollection(ObjectType, ICollection, IEnumerable):
    ...
    @property
    def IsSynchronized(self) -> BooleanType: ...
    def __getitem__(self, key: IntType) -> SignerInfo: ...
    @property
    def SyncRoot(self) -> ObjectType: ...
