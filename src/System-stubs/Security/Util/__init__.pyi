...
class StringExpressionSet(ObjectType):
    ...
    @overload
    def AddExpressions(
        self, str: ArrayType[StringType], checkForDuplicates: BooleanType, needFullPath: BooleanType
    ) -> VoidType: ...
    @overload
    def AddExpressions(
        self, exprArrayList: ArrayList, checkForDuplicates: BooleanType
    ) -> VoidType: ...
...
class XMLUtil(ABC, ObjectType):
    ...
    @staticmethod
    def AddClassAttribute(
        element: SecurityElement, type: TypeType, typename: StringType
    ) -> VoidType: ...
    @staticmethod
    ...
    def CreatePermission(
        el: SecurityElement, permState: PermissionState, ignoreTypeLoadFailures: BooleanType
    ) -> IPermission: ...
    @staticmethod
