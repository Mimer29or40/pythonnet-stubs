...
class HostSecurityManager(ObjectType):
    ...
    def GenerateAssemblyEvidence(
        self, evidenceType: TypeType, assembly: Assembly
    ) -> EvidenceBase: ...
...
class PermissionSet(
    ObjectType, ISecurityEncodable, ICollection, IEnumerable, IStackWalk, IDeserializationCallback
):
    # No Fields
    ...
    def ConvertPermissionSet(
        inFormat: StringType, inData: ArrayType[ByteType], outFormat: StringType
    ) -> ArrayType[ByteType]: ...
    def Copy(self) -> PermissionSet: ...
...
class SecurityContext(ObjectType, IDisposable):
    ...
    @staticmethod
    def Run(
        securityContext: SecurityContext, callback: ContextCallback, state: ObjectType
    ) -> VoidType: ...
    @staticmethod
...
class SecurityDocument(ObjectType):
    ...
    def ConvertElement(
        self, elCurrent: SecurityElement, position: IntType
    ) -> Tuple[VoidType, IntType]: ...
    @staticmethod
    def EncodedStringSize(str: StringType) -> IntType: ...
    def GetAttributeForElement(
        self, position: IntType, attributeName: StringType
    ) -> StringType: ...
...
class SecurityManager(ABC, ObjectType):
    ...
    def GetZoneAndOrigin(
        zone: ArrayList, origin: ArrayList
    ) -> Tuple[VoidType, ArrayList, ArrayList]: ...
    @staticmethod
