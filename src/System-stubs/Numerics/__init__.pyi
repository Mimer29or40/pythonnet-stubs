...
class NumericsHelpers(ABC, ObjectType):
    ...
    @staticmethod
    def GetDoubleParts(
        dbl: DoubleType, sign: IntType, exp: IntType, man: ULongType, fFinite: BooleanType
    ) -> Tuple[VoidType, IntType, IntType, ULongType, BooleanType]: ...
    @staticmethod
...
class BigInteger(
    ValueType, IFormattable, IComparable, IComparable[BigInteger], IEquatable[BigInteger]
):
    # No Fields
    ...
    @staticmethod
    def DivRem(
        dividend: BigInteger, divisor: BigInteger, remainder: BigInteger
    ...
    @overload
    def TryParse(
        value: StringType, style: NumberStyles, provider: IFormatProvider, result: BigInteger
    ) -> Tuple[BooleanType, BigInteger]: ...
...
class BigIntegerBuilder(ValueType):
    ...
    @staticmethod
    def GCD(
        reg1: BigIntegerBuilder, reg2: BigIntegerBuilder
    ) -> Tuple[VoidType, BigIntegerBuilder, BigIntegerBuilder]: ...
    def GetApproxParts(
        self, exp: IntType, man: ULongType
    ) -> Tuple[VoidType, IntType, ULongType]: ...
    def GetInteger(self, sign: IntType) -> BigInteger: ...
    @overload
    def Load(self, reg: BigIntegerBuilder) -> Tuple[VoidType, BigIntegerBuilder]: ...
    @overload
    def Load(
        self, reg: BigIntegerBuilder, cuExtra: IntType
    ) -> Tuple[VoidType, BigIntegerBuilder]: ...
    ...
    def ModDiv(
        self, regDen: BigIntegerBuilder, regQuo: BigIntegerBuilder
    ) -> Tuple[VoidType, BigIntegerBuilder, BigIntegerBuilder]: ...
    @overload
    def Mul(self, regMul: BigIntegerBuilder) -> Tuple[VoidType, BigIntegerBuilder]: ...
    @overload
    def Mul(
        self, reg1: BigIntegerBuilder, reg2: BigIntegerBuilder
    ) -> Tuple[VoidType, BigIntegerBuilder, BigIntegerBuilder]: ...
    @overload
    ...
    @overload
    def Sub(
        self, sign: IntType, reg: BigIntegerBuilder
    ) -> Tuple[VoidType, IntType, BigIntegerBuilder]: ...
...
class Matrix4x4(ValueType, IEquatable[Matrix4x4]):
    ...
    def CreateOrthographic(
        width: FloatType, height: FloatType, zNearPlane: FloatType, zFarPlane: FloatType
    ) -> Matrix4x4: ...
    @staticmethod
    ...
    def CreatePerspective(
        width: FloatType,
        height: FloatType,
        nearPlaneDistance: FloatType,
        farPlaneDistance: FloatType,
    ) -> Matrix4x4: ...
    @staticmethod
    def CreatePerspectiveFieldOfView(
        fieldOfView: FloatType,
    ...
    @overload
    def CreateScale(
        xScale: FloatType, yScale: FloatType, zScale: FloatType, centerPoint: Vector3
    ) -> Matrix4x4: ...
    @staticmethod
    @overload
    ...
    def CreateTranslation(
        xPosition: FloatType, yPosition: FloatType, zPosition: FloatType
    ) -> Matrix4x4: ...
    @staticmethod
    def CreateWorld(position: Vector3, forward: Vector3, up: Vector3) -> Matrix4x4: ...
    @staticmethod
    def Decompose(
        matrix: Matrix4x4, scale: Vector3, rotation: Quaternion, translation: Vector3
    ) -> Tuple[BooleanType, Vector3, Quaternion, Vector3]: ...
    @overload
...
class Quaternion(ValueType, IEquatable[Quaternion]):
    ...
    @staticmethod
    def Slerp(
        quaternion1: Quaternion, quaternion2: Quaternion, amount: FloatType
    ) -> Quaternion: ...
    @staticmethod
