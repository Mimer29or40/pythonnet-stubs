...
from System.Xml import XmlNamespaceScope
...
class XPathNavigator(ABC, XPathItem, ICloneable, IXPathNavigable, IXmlNamespaceResolver):
    ...
    def AppendChildElement(
        self, prefix: StringType, localName: StringType, namespaceURI: StringType, value: StringType
    ) -> VoidType: ...
    def CheckValidity(
    ...
    def SelectSingleNode(
        self, xpath: StringType, resolver: IXmlNamespaceResolver
    ) -> XPathNavigator: ...
    @overload
...
class XPathNavigatorReaderWithSI(
    XPathNavigatorReader, IDisposable, IXmlNamespaceResolver, IXmlSchemaInfo
):
    # No Fields
