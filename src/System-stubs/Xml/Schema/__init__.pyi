...
from System.Xml import IDtdAttributeInfo
from System.Xml import IDtdAttributeListInfo
from System.Xml import IDtdDefaultAttributeInfo
from System.Xml import IDtdEntityInfo
from System.Xml import IDtdInfo
from System.Xml import IDtdParserAdapter
from System.Xml import IValidationEventHandling
from System.Xml import IXmlLineInfo
from System.Xml import IXmlNamespaceResolver
from System.Xml import PositionInfo
...
from System.Xml import XmlTokenizedType
from System.Xml import XmlValidatingReaderImpl
...
class AllElementsContentValidator(ContentValidator):
    ...
    def __init__(
        self, contentType: XmlSchemaContentType, size: IntType, isEmptiable: BooleanType
    ): ...
    ...
    def AddElement(
        self, name: XmlQualifiedName, particle: ObjectType, isEmptiable: BooleanType
    ) -> BooleanType: ...
    def CompleteValidation(self, context: ValidationState) -> BooleanType: ...
    def ExpectedElements(
        self, context: ValidationState, isRequiredOnly: BooleanType
    ) -> ArrayList: ...
    def ExpectedParticles(
        self, context: ValidationState, isRequiredOnly: BooleanType, schemaSet: XmlSchemaSet
    ) -> ArrayList: ...
    def InitValidation(self, context: ValidationState) -> VoidType: ...
    def ValidateElement(
        self, name: XmlQualifiedName, context: ValidationState, errorCode: IntType
...
class Asttree(ObjectType):
    ...
    def CompileXPath(
        self, xPath: StringType, isField: BooleanType, nsmgr: XmlNamespaceManager
    ) -> VoidType: ...
...
class AutoValidator(BaseValidator):
    ...
    def __init__(
        ...
        eventHandling: IValidationEventHandling,
    ): ...
...
class BaseValidator(ObjectType):
    ...
    def CreateInstance(
        ...
        schemaCollection: XmlSchemaCollection,
        eventHandling: IValidationEventHandling,
        processIdentityConstraints: BooleanType,
    ) -> BaseValidator: ...
    def FindId(self, name: StringType) -> ObjectType: ...
    def Validate(self) -> VoidType: ...
...
class ChoiceNode(InteriorNode):
    ...
    def ConstructPos(
        self, firstpos: BitSet, lastpos: BitSet, followpos: ArrayType[BitSet]
    ) -> VoidType: ...
    def ExpandTree(
        self, parent: InteriorNode, symbols: SymbolsDictionary, positions: Positions
    ) -> VoidType: ...
...
class ContentValidator(ObjectType):
    ...
    @staticmethod
    @overload
    def AddParticleToExpected(
        p: XmlSchemaParticle, schemaSet: XmlSchemaSet, particles: ArrayList
    ) -> VoidType: ...
    @staticmethod
    @overload
    def AddParticleToExpected(
        p: XmlSchemaParticle, schemaSet: XmlSchemaSet, particles: ArrayList, _global: BooleanType
    ) -> VoidType: ...
    def CompleteValidation(self, context: ValidationState) -> BooleanType: ...
    def ExpectedElements(
        self, context: ValidationState, isRequiredOnly: BooleanType
...
class DatatypeImplementation(ABC, XmlSchemaDatatype):
    ...
    def ParseValue(
        self, s: StringType, nameTable: XmlNameTable, nsmgr: IXmlNamespaceResolver
    ) -> ObjectType: ...
...
class DtdValidator(BaseValidator):
    ...
    def CheckDefaultValue(
        ...
        sinfo: SchemaInfo,
        eventHandling: IValidationEventHandling,
        baseUriStr: StringType,
    ) -> VoidType: ...
    def CompleteValidation(self) -> VoidType: ...
    def FindId(self, name: StringType) -> ObjectType: ...
    @staticmethod
    def SetDefaultTypedValue(
        attdef: SchemaAttDef, readerAdapter: IDtdParserAdapter
    ) -> VoidType: ...
    def Validate(self) -> VoidType: ...
    def get_PreserveWhitespace(self) -> BooleanType: ...
...
class NamespaceList(ObjectType):
    ...
    @staticmethod
    def Intersection(
        o1: NamespaceList, o2: NamespaceList, v1Compat: BooleanType
    ) -> NamespaceList: ...
    def IsEmpty(self) -> BooleanType: ...
    @staticmethod
...
class Preprocessor(BaseProcessor):
    ...
    def Execute(
        self, schema: XmlSchema, targetNamespace: StringType, loadExternals: BooleanType
    ) -> BooleanType: ...
...
class SchemaCollectionCompiler(BaseProcessor):
    ...
    def Execute(
        self, schema: XmlSchema, schemaInfo: SchemaInfo, compileContentModel: BooleanType
    ) -> BooleanType: ...
...
class SchemaCollectionPreprocessor(BaseProcessor):
    ...
    def Execute(
        self,
        schema: XmlSchema,
        targetNamespace: StringType,
        loadExternals: BooleanType,
...
class SymbolsDictionary(ObjectType):
    ...
    def AddNamespaceList(
        self, list: NamespaceList, particle: ObjectType, allowLocal: BooleanType
    ) -> VoidType: ...
    def Exists(self, name: XmlQualifiedName) -> BooleanType: ...
...
class XmlAnyConverter(XmlBaseConverter):
    ...
    @overload
    def ChangeType(
        self, value: StringType, destinationType: TypeType, nsResolver: IXmlNamespaceResolver
    ) -> ObjectType: ...
    @overload
    def ChangeType(
        self, value: ObjectType, destinationType: TypeType, nsResolver: IXmlNamespaceResolver
    ) -> ObjectType: ...
    @overload
...
class XmlSchema(XmlSchemaObject):
    ...
    @overload
    def Compile(
        self, validationEventHandler: ValidationEventHandler, resolver: XmlResolver
    ) -> VoidType: ...
    @overload
...
class XmlSchemaDatatype(ABC, ObjectType):
    ...
    @overload
    def ChangeType(
        self, value: ObjectType, targetType: TypeType, namespaceResolver: IXmlNamespaceResolver
    ) -> ObjectType: ...
    def IsDerivedFrom(self, datatype: XmlSchemaDatatype) -> BooleanType: ...
    def ParseValue(
        self, s: StringType, nameTable: XmlNameTable, nsmgr: IXmlNamespaceResolver
...
class XmlSchemaType(XmlSchemaAnnotated):
    ...
    @staticmethod
    def IsDerivedFrom(
        derivedType: XmlSchemaType, baseType: XmlSchemaType, _except: XmlSchemaDerivationMethod
    ) -> BooleanType: ...
...
class XmlSchemaValidator(ObjectType):
    ...
    @overload
    def ValidateElement(
        self, localName: StringType, namespaceUri: StringType, schemaInfo: XmlSchemaInfo
    ) -> VoidType: ...
    @overload
    def ValidateElement(
        self,
        ...
        xsiType: StringType,
        xsiNil: StringType,
        xsiSchemaLocation: StringType,
        xsiNoNamespaceSchemaLocation: StringType,
    ) -> VoidType: ...
    @overload
    def ValidateEndElement(self, schemaInfo: XmlSchemaInfo) -> ObjectType: ...
    @overload
    def ValidateEndElement(
        self, schemaInfo: XmlSchemaInfo, typedValue: ObjectType
    ) -> ObjectType: ...
