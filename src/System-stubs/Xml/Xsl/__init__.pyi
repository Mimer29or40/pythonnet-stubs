...
from System.CodeDom.Compiler import TempFileCollection
...
from System.Xml import XmlWriterSettings
...
class XslCompiledTransform(ObjectType):
    ...
    def CompileToType(
        ...
        scriptAssemblyPath: StringType,
    ) -> CompilerErrorCollection: ...
    @overload
    def Load(
        self, stylesheet: XmlReader, settings: XsltSettings, stylesheetResolver: XmlResolver
    ) -> VoidType: ...
    @overload
    def Load(
        self, stylesheet: IXPathNavigable, settings: XsltSettings, stylesheetResolver: XmlResolver
    ) -> VoidType: ...
    @overload
    def Load(
        self, stylesheetUri: StringType, settings: XsltSettings, stylesheetResolver: XmlResolver
    ) -> VoidType: ...
    @overload
    ...
    def Load(
        ...
        queryData: ArrayType[ByteType],
        earlyBoundTypes: ArrayType[TypeType],
    ) -> VoidType: ...
    @overload
    def Transform(self, input: IXPathNavigable, results: XmlWriter) -> VoidType: ...
    @overload
    def Transform(
        self, input: IXPathNavigable, arguments: XsltArgumentList, results: XmlWriter
    ) -> VoidType: ...
    @overload
    def Transform(
        self, input: IXPathNavigable, arguments: XsltArgumentList, results: TextWriter
    ) -> VoidType: ...
    @overload
    def Transform(
        self, input: IXPathNavigable, arguments: XsltArgumentList, results: Stream
    ) -> VoidType: ...
    @overload
    def Transform(self, input: XmlReader, results: XmlWriter) -> VoidType: ...
    @overload
    def Transform(
        self, input: XmlReader, arguments: XsltArgumentList, results: XmlWriter
    ) -> VoidType: ...
    @overload
    def Transform(
        self, input: XmlReader, arguments: XsltArgumentList, results: TextWriter
    ) -> VoidType: ...
    @overload
    def Transform(
        self, input: XmlReader, arguments: XsltArgumentList, results: Stream
    ) -> VoidType: ...
    @overload
    def Transform(self, inputUri: StringType, results: XmlWriter) -> VoidType: ...
    @overload
    def Transform(
        self, inputUri: StringType, arguments: XsltArgumentList, results: XmlWriter
    ) -> VoidType: ...
    @overload
    def Transform(
        self, inputUri: StringType, arguments: XsltArgumentList, results: TextWriter
    ) -> VoidType: ...
    @overload
    def Transform(
        self, inputUri: StringType, arguments: XsltArgumentList, results: Stream
    ) -> VoidType: ...
    @overload
...
class XslTransform(ObjectType):
    ...
    @overload
    def Load(
        self, stylesheet: IXPathNavigable, resolver: XmlResolver, evidence: Evidence
    ) -> VoidType: ...
    @overload
    def Load(
        self, stylesheet: XmlReader, resolver: XmlResolver, evidence: Evidence
    ) -> VoidType: ...
    @overload
    def Load(
        self, stylesheet: XPathNavigator, resolver: XmlResolver, evidence: Evidence
    ) -> VoidType: ...
    @overload
    def Load(self, stylesheet: XmlReader) -> VoidType: ...
    @overload
    ...
    @overload
    def Transform(
        self, input: XPathNavigator, args: XsltArgumentList, resolver: XmlResolver
    ) -> XmlReader: ...
    @overload
    def Transform(self, input: IXPathNavigable, args: XsltArgumentList) -> XmlReader: ...
    @overload
    def Transform(
        self, input: IXPathNavigable, args: XsltArgumentList, resolver: XmlResolver
    ) -> XmlReader: ...
    @overload
    def Transform(
        self,
    ...
    @overload
    def Transform(
        self, input: IXPathNavigable, args: XsltArgumentList, output: Stream, resolver: XmlResolver
    ) -> VoidType: ...
    @overload
    def Transform(
        self,
    ...
    @overload
    def Transform(
        self, inputfile: StringType, outputfile: StringType, resolver: XmlResolver
    ) -> VoidType: ...
    @overload
    ...
    @overload
    def Transform(
        self, input: XPathNavigator, args: XsltArgumentList, output: XmlWriter
    ) -> VoidType: ...
    @overload
    def Transform(
        self, input: XPathNavigator, args: XsltArgumentList, output: Stream, resolver: XmlResolver
    ) -> VoidType: ...
    @overload
    def Transform(
        self, input: XPathNavigator, args: XsltArgumentList, output: Stream
    ) -> VoidType: ...
    @overload
    def Transform(
        self,
    ...
    @overload
    def Transform(
        self, input: XPathNavigator, args: XsltArgumentList, output: TextWriter
    ) -> VoidType: ...
    @overload
    def Transform(
        self, input: IXPathNavigable, args: XsltArgumentList, output: TextWriter
    ) -> VoidType: ...
    @overload
    def Transform(
        self, input: IXPathNavigable, args: XsltArgumentList, output: Stream
    ) -> VoidType: ...
    @overload
    def Transform(
        self, input: IXPathNavigable, args: XsltArgumentList, output: XmlWriter
    ) -> VoidType: ...
    @overload
...
class XsltArgumentList(ObjectType):
    ...
    def AddParam(
        self, name: StringType, namespaceUri: StringType, parameter: ObjectType
    ) -> VoidType: ...
    ...
    def remove_XsltMessageEncountered(
        self, value: XsltMessageEncounteredEventHandler
    ) -> VoidType: ...
...
class XsltCompileException(XsltException, ISerializable, _Exception):
    ...
    @overload
    def __init__(
        self, inner: Exception, sourceUri: StringType, lineNumber: IntType, linePosition: IntType
    ): ...
...
class XsltContext(ABC, XmlNamespaceManager, IXmlNamespaceResolver, IEnumerable):
    ...
    def ResolveFunction(
        self, prefix: StringType, name: StringType, ArgTypes: ArrayType[XPathResultType]
...
class XsltMessageEncounteredEventHandler(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(
        self,
        sender: ObjectType,
        e: XsltMessageEncounteredEventArgs,
...
class IXsltContextFunction(Protocol):
    ...
    def Invoke(
        self, xsltContext: XsltContext, args: ArrayType[ObjectType], docContext: XPathNavigator
    ) -> ObjectType: ...
...
XsltMessageEncounteredEventHandler = Callable[
    [ObjectType, XsltMessageEncounteredEventArgs], VoidType
]
