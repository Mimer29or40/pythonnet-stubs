...
from System.Collections import CaseInsensitiveComparer
...
from System.Reflection.Emit import LocalBuilder
...
from System.Xml import ReadState
from System.Xml import WhitespaceHandling
...
from System.Xml import XmlSpace
...
from System.Xml.Schema import XmlSchemaForm
...
class CodeGeneratorConversionException(Exception, ISerializable, _Exception):
    ...
    def __init__(
        self, sourceType: TypeType, targetType: TypeType, isAddress: BooleanType, reason: StringType
    ): ...
...
class LocalScope(ObjectType):
    ...
    def __getitem__(self, key: StringType) -> LocalBuilder: ...
    def __setitem__(self, key: StringType, value: LocalBuilder) -> None: ...

    # ---------- Methods ---------- #

    def Add(self, key: StringType, value: LocalBuilder) -> VoidType: ...
    def AddToFreeLocals(
        self, freeLocals: Dictionary[Tuple[TypeType, StringType], Queue[LocalBuilder]]
    ) -> VoidType: ...
    def ContainsKey(self, key: StringType) -> BooleanType: ...
    def TryGetValue(
        self, key: StringType, value: LocalBuilder
    ) -> Tuple[BooleanType, LocalBuilder]: ...
...
class SoapAttributeOverrides(ObjectType):
    ...
    def __getitem__(self, key: TypeType) -> SoapAttributes: ...
    def __getitem__(self, key: TypeType) -> SoapAttributes: ...
...
class SoapCodeExporter(CodeExporter):
    ...
    @overload
    def AddMappingMetadata(
        self,
        metadata: CodeAttributeDeclarationCollection,
        member: XmlMemberMapping,
        forceUseMemberName: BooleanType,
    ) -> VoidType: ...
    @overload
    def AddMappingMetadata(
        self, metadata: CodeAttributeDeclarationCollection, member: XmlMemberMapping
    ) -> VoidType: ...
...
class SoapReflectionImporter(ObjectType):
    ...
    @overload
    def __init__(
        self, attributeOverrides: SoapAttributeOverrides, defaultNamespace: StringType
    ): ...
    ...
    @overload
    def ImportMembersMapping(
        self, elementName: StringType, ns: StringType, members: ArrayType[XmlReflectionMember]
    ) -> XmlMembersMapping: ...
    @overload
    def ImportMembersMapping(
        self,
        ...
        ns: StringType,
        members: ArrayType[XmlReflectionMember],
        hasWrapperElement: BooleanType,
        writeAccessors: BooleanType,
    ) -> XmlMembersMapping: ...
    @overload
    def ImportMembersMapping(
        self,
...
class SoapSchemaExporter(ObjectType):
    ...
    def ExportMembersMapping(self, xmlMembersMapping: XmlMembersMapping) -> VoidType: ...
    @overload
    def ExportMembersMapping(
        self, xmlMembersMapping: XmlMembersMapping, exportEnclosingType: BooleanType
    ) -> VoidType: ...
    def ExportTypeMapping(self, xmlTypeMapping: XmlTypeMapping) -> VoidType: ...
...
class SoapSchemaImporter(SchemaImporter):
    ...
    @overload
    def __init__(
        self, schemas: XmlSchemas, typeIdentifiers: CodeIdentifiers, options: CodeGenerationOptions
    ): ...
    @overload
    def __init__(
        self, schemas: XmlSchemas, options: CodeGenerationOptions, context: ImportContext
    ): ...
    @overload
    def __init__(
        self,
    ...
    def ImportDerivedTypeMapping(
        self, name: XmlQualifiedName, baseType: TypeType, baseTypeCanBeIndirect: BooleanType
    ) -> XmlTypeMapping: ...
    @overload
    def ImportMembersMapping(
        self, name: StringType, ns: StringType, members: ArrayType[SoapSchemaMember]
    ) -> XmlMembersMapping: ...
    @overload
    def ImportMembersMapping(
        self,
        name: StringType,
        ns: StringType,
        members: ArrayType[SoapSchemaMember],
        hasWrapperElement: BooleanType,
    ) -> XmlMembersMapping: ...
    @overload
    def ImportMembersMapping(
        self, name: StringType, ns: StringType, member: SoapSchemaMember
    ) -> XmlMembersMapping: ...
    @overload
    def ImportMembersMapping(
        self,
        ...
        hasWrapperElement: BooleanType,
        baseType: TypeType,
        baseTypeCanBeIndirect: BooleanType,
    ) -> XmlMembersMapping: ...
...
class TypeExtensions(ABC, ObjectType):
    ...
    @staticmethod
    def TryConvertTo(
        targetType: TypeType, data: ObjectType, returnValue: ObjectType
...
class XmlAnyElementAttributes(CollectionBase, IList, ICollection, IEnumerable):
    ...
    def __getitem__(self, key: IntType) -> XmlAnyElementAttribute: ...
    def __setitem__(self, key: IntType, value: XmlAnyElementAttribute) -> None: ...
...
class XmlArrayItemAttributes(CollectionBase, IList, ICollection, IEnumerable):
    ...
    def __getitem__(self, key: IntType) -> XmlArrayItemAttribute: ...
    def __setitem__(self, key: IntType, value: XmlArrayItemAttribute) -> None: ...
...
class XmlAttributeOverrides(ObjectType):
    ...
    def __getitem__(self, key: TypeType) -> XmlAttributes: ...
    def __getitem__(self, key: TypeType) -> XmlAttributes: ...
...
class XmlCodeExporter(CodeExporter):
    ...
    @overload
    def AddMappingMetadata(
        self, metadata: CodeAttributeDeclarationCollection, mapping: XmlTypeMapping, ns: StringType
    ) -> VoidType: ...
    @overload
    def AddMappingMetadata(
        self,
    ...
    @overload
    def AddMappingMetadata(
        self, metadata: CodeAttributeDeclarationCollection, member: XmlMemberMapping, ns: StringType
    ) -> VoidType: ...
    def ExportMembersMapping(self, xmlMembersMapping: XmlMembersMapping) -> VoidType: ...
    def ExportTypeMapping(self, xmlTypeMapping: XmlTypeMapping) -> VoidType: ...
...
class XmlCountingReader(XmlReader, IDisposable, IXmlTextParser, IXmlLineInfo):
    ...
    def ReadContentAs(
        self, returnType: TypeType, namespaceResolver: IXmlNamespaceResolver
    ) -> ObjectType: ...
    def ReadContentAsBase64(
        self, buffer: ArrayType[ByteType], index: IntType, count: IntType
    ) -> IntType: ...
    def ReadContentAsBinHex(
        self, buffer: ArrayType[ByteType], index: IntType, count: IntType
    ) -> IntType: ...
    ...
    @overload
    def ReadElementContentAsBoolean(
        self, localName: StringType, namespaceURI: StringType
    ) -> BooleanType: ...
    @overload
    def ReadElementContentAsDateTime(self) -> DateTime: ...
    @overload
    def ReadElementContentAsDateTime(
        self, localName: StringType, namespaceURI: StringType
    ) -> DateTime: ...
    @overload
    def ReadElementContentAsDouble(self) -> DoubleType: ...
    @overload
    def ReadElementContentAsDouble(
        self, localName: StringType, namespaceURI: StringType
    ) -> DoubleType: ...
    @overload
...
class XmlElementAttributes(CollectionBase, IList, ICollection, IEnumerable):
    ...
    def __getitem__(self, key: IntType) -> XmlElementAttribute: ...
    def __setitem__(self, key: IntType, value: XmlElementAttribute) -> None: ...
...
class XmlMembersMapping(XmlMapping):
    ...
    def __getitem__(self, key: IntType) -> XmlMemberMapping: ...
    @property
    def TypeName(self) -> StringType: ...
    @property
    def TypeNamespace(self) -> StringType: ...
...
class XmlNodeEventHandler(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(
        self, sender: ObjectType, e: XmlNodeEventArgs, callback: AsyncCallback, object: ObjectType
    ) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> VoidType: ...
...
class XmlReflectionImporter(ObjectType):
    ...
    @overload
    def ImportTypeMapping(
        self, type: TypeType, root: XmlRootAttribute, defaultNamespace: StringType
    ) -> XmlTypeMapping: ...
    def IncludeType(self, type: TypeType) -> VoidType: ...
    def IncludeTypes(self, provider: ICustomAttributeProvider) -> VoidType: ...
...
class XmlSchemaImporter(SchemaImporter):
    ...
    def ImportAnyType(
        self, typeName: XmlQualifiedName, elementName: StringType
    ) -> XmlMembersMapping: ...
    @overload
    def ImportDerivedTypeMapping(
        self, name: XmlQualifiedName, baseType: TypeType
    ) -> XmlTypeMapping: ...
    @overload
    def ImportDerivedTypeMapping(
        self, name: XmlQualifiedName, baseType: TypeType, baseTypeCanBeIndirect: BooleanType
    ...
    def ImportMembersMapping(
        self,
        names: ArrayType[XmlQualifiedName],
        baseType: TypeType,
        baseTypeCanBeIndirect: BooleanType,
    ) -> XmlMembersMapping: ...
    @overload
    ...
    def ImportSchemaType(
        self, typeName: XmlQualifiedName, baseType: TypeType
    ) -> XmlTypeMapping: ...
    @overload
    def ImportSchemaType(
        self, typeName: XmlQualifiedName, baseType: TypeType, baseTypeCanBeIndirect: BooleanType
    ) -> XmlTypeMapping: ...
...
class XmlSchemas(CollectionBase, IList, ICollection, IEnumerable, IEnumerable[XmlSchema]):
    ...
    def __getitem__(self, key: IntType) -> XmlSchema: ...
    def __setitem__(self, key: IntType, value: XmlSchema) -> None: ...
...
class XmlSerializationFixupCallback(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(
        self, fixup: ObjectType, callback: AsyncCallback, object: ObjectType
    ) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> VoidType: ...
...
class XmlSerializationWriteCallback(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(
        self, o: ObjectType, callback: AsyncCallback, object: ObjectType
    ) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> VoidType: ...
...
class XmlSerializer(ObjectType):
    ...
    @overload
    def Deserialize(
        self, xmlReader: XmlReader, encodingStyle: StringType, events: XmlDeserializationEvents
    ) -> ObjectType: ...
    @staticmethod
    @overload
    ...
    @overload
    def FromMappings(
        mappings: ArrayType[XmlMapping], type: TypeType
    ) -> ArrayType[XmlSerializer]: ...
    @staticmethod
    @overload
    def FromMappings(
        mappings: ArrayType[XmlMapping], evidence: Evidence
    ) -> ArrayType[XmlSerializer]: ...
    @staticmethod
    ...
    def GenerateSerializer(
        types: ArrayType[TypeType], mappings: ArrayType[XmlMapping]
    ) -> Assembly: ...
    @staticmethod
    @overload
    def GenerateSerializer(
        types: ArrayType[TypeType], mappings: ArrayType[XmlMapping], parameters: CompilerParameters
    ) -> Assembly: ...
    @staticmethod
    @overload
    ...
    @staticmethod
    @overload
    def GetXmlSerializerAssemblyName(
        type: TypeType, defaultNamespace: StringType
    ) -> StringType: ...
    @overload
    def Serialize(self, textWriter: TextWriter, o: ObjectType) -> VoidType: ...
    @overload
    def Serialize(
        self, textWriter: TextWriter, o: ObjectType, namespaces: XmlSerializerNamespaces
    ) -> VoidType: ...
    @overload
    def Serialize(self, stream: Stream, o: ObjectType) -> VoidType: ...
    @overload
    def Serialize(
        self, stream: Stream, o: ObjectType, namespaces: XmlSerializerNamespaces
    ) -> VoidType: ...
    @overload
    def Serialize(self, xmlWriter: XmlWriter, o: ObjectType) -> VoidType: ...
    @overload
    def Serialize(
        self, xmlWriter: XmlWriter, o: ObjectType, namespaces: XmlSerializerNamespaces
    ) -> VoidType: ...
    @overload
    def Serialize(
        self,
...
class XmlSerializerFactory(ObjectType):
    ...
    @overload
    def CreateSerializer(
        self, type: TypeType, extraTypes: ArrayType[TypeType]
    ) -> XmlSerializer: ...
    @overload
    ...
    @overload
    def CreateSerializer(
        self, type: TypeType, overrides: XmlAttributeOverrides
    ) -> XmlSerializer: ...
