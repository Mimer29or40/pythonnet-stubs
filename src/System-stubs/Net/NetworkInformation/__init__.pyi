...
class GatewayIPAddressInformationCollection(
    ...
    def CopyTo(
        self, array: ArrayType[GatewayIPAddressInformation], offset: IntType
    ) -> VoidType: ...
...
class IPAddressInformationCollection(
    ObjectType, ICollection[IPAddressInformation], IEnumerable[IPAddressInformation], IEnumerable
):
    # No Fields
...
class IPGlobalProperties(ABC, ObjectType):
    ...
    def BeginGetUnicastAddresses(
        self, callback: AsyncCallback, state: ObjectType
    ) -> IAsyncResult: ...
...
class MulticastIPAddressInformationCollection(
    ...
    def CopyTo(
        self, array: ArrayType[MulticastIPAddressInformation], offset: IntType
    ) -> VoidType: ...
...
class NetworkAvailabilityChangedEventHandler(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(
        self,
        sender: ObjectType,
        e: NetworkAvailabilityEventArgs,
...
class NetworkChange(ObjectType):
    ...
    @staticmethod
    def add_NetworkAvailabilityChanged(
        value: NetworkAvailabilityChangedEventHandler,
    ) -> VoidType: ...
    @staticmethod
    def remove_NetworkAddressChanged(value: NetworkAddressChangedEventHandler) -> VoidType: ...
    @staticmethod
    def remove_NetworkAvailabilityChanged(
        value: NetworkAvailabilityChangedEventHandler,
    ) -> VoidType: ...
...
class Ping(Component, IComponent, IDisposable):
    ...
    @overload
    def Send(
        self, hostNameOrAddress: StringType, timeout: IntType, buffer: ArrayType[ByteType]
    ) -> PingReply: ...
    @overload
    def Send(
        self, address: IPAddress, timeout: IntType, buffer: ArrayType[ByteType]
    ) -> PingReply: ...
    @overload
    def Send(
        self,
        hostNameOrAddress: StringType,
        timeout: IntType,
    ...
    @overload
    def SendAsync(
        self, hostNameOrAddress: StringType, timeout: IntType, userToken: ObjectType
    ) -> VoidType: ...
    @overload
    def SendAsync(self, address: IPAddress, userToken: ObjectType) -> VoidType: ...
    @overload
    def SendAsync(
        self, address: IPAddress, timeout: IntType, userToken: ObjectType
    ) -> VoidType: ...
    @overload
    def SendAsync(
        self,
...
class StableUnicastIpAddressTableDelegate(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(
        self, context: NIntType, table: NIntType, callback: AsyncCallback, object: ObjectType
    ) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> VoidType: ...
...
class TeredoHelper(ObjectType):
    ...
    def UnsafeNotifyStableUnicastIpAddressTable(
        callback: Action[ObjectType], state: ObjectType
    ) -> BooleanType: ...
...
class UnicastIPAddressInformationCollection(
    ...
    def CopyTo(
        self, array: ArrayType[UnicastIPAddressInformation], offset: IntType
    ) -> VoidType: ...
...
NetworkAvailabilityChangedEventHandler = Callable[
    [ObjectType, NetworkAvailabilityEventArgs], VoidType
]
