...
class AuthenticationModuleElementCollection(
    ...
    def __getitem__(self, key: IntType) -> AuthenticationModuleElement: ...
    def __setitem__(self, key: IntType, value: AuthenticationModuleElement) -> None: ...
    def __getitem__(self, key: StringType) -> AuthenticationModuleElement: ...
    def __setitem__(self, key: StringType, value: AuthenticationModuleElement) -> None: ...
...
class BypassElementCollection(ConfigurationElementCollection, ICollection, IEnumerable):
    ...
    def __getitem__(self, key: IntType) -> BypassElement: ...
    def __setitem__(self, key: IntType, value: BypassElement) -> None: ...
    def __getitem__(self, key: StringType) -> BypassElement: ...
    def __setitem__(self, key: StringType, value: BypassElement) -> None: ...
...
class ConnectionManagementElementCollection(
    ...
    def __getitem__(self, key: IntType) -> ConnectionManagementElement: ...
    def __setitem__(self, key: IntType, value: ConnectionManagementElement) -> None: ...
    def __getitem__(self, key: StringType) -> ConnectionManagementElement: ...
    def __setitem__(self, key: StringType, value: ConnectionManagementElement) -> None: ...
...
class WebRequestModuleElementCollection(ConfigurationElementCollection, ICollection, IEnumerable):
    ...
    def __getitem__(self, key: IntType) -> WebRequestModuleElement: ...
    def __setitem__(self, key: IntType, value: WebRequestModuleElement) -> None: ...
    def __getitem__(self, key: StringType) -> WebRequestModuleElement: ...
    def __setitem__(self, key: StringType, value: WebRequestModuleElement) -> None: ...
