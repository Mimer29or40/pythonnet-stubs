...
class CopyEncoder(ObjectType):
    ...
    def GetBlock(
        self, input: DeflateInput, output: OutputBuffer, isFinal: BooleanType
    ) -> VoidType: ...
...
class Crc32Helper(ABC, ObjectType):
    ...
    @staticmethod
    def UpdateCrc32(
        crc32: UIntType, buffer: ArrayType[ByteType], offset: IntType, length: IntType
    ) -> UIntType: ...
...
class DeflateStream(Stream, IDisposable):
    ...
    @overload
    def __init__(
        self, stream: Stream, compressionLevel: CompressionLevel, leaveOpen: BooleanType
    ): ...
...
class FastEncoderWindow(ObjectType):
    ...
    def CopyBytes(
        self, inputBuffer: ArrayType[ByteType], startIndex: IntType, count: IntType
    ) -> VoidType: ...
...
class GZipDecoder(ObjectType, IFileFormatReader):
    ...
    def UpdateWithBytesRead(
        self, buffer: ArrayType[ByteType], offset: IntType, copied: IntType
    ) -> VoidType: ...
...
class GZipFormatter(ObjectType, IFileFormatWriter):
    ...
    def UpdateWithBytesRead(
        self, buffer: ArrayType[ByteType], offset: IntType, bytesToCopy: IntType
    ) -> VoidType: ...
...
class Inflater(ObjectType, IInflater, IDisposable):
    ...
    def SetInput(
        self, inputBytes: ArrayType[ByteType], offset: IntType, length: IntType
    ) -> VoidType: ...
...
class InputBuffer(ObjectType):
    ...
    def NeedsInput(self) -> BooleanType: ...
    def SetInput(
        self, buffer: ArrayType[ByteType], offset: IntType, length: IntType
    ) -> VoidType: ...
...
class ZLibException(IOException, ISerializable, _Exception):
    ...
    def __init__(
        self,
        message: StringType,
        zlibErrorContext: StringType,
        zlibErrorCode: IntType,
        zlibErrorMessage: StringType,
    ): ...
    @overload
    def __init__(self): ...
    @overload
...
class ZLibNative(ABC, ObjectType):
    ...
    ) -> Tuple[ErrorCode, ZLibStreamHandle]: ...
    @staticmethod
    @overload
    def CreateZLibStreamForDeflate(
        zLibStreamHandle: ZLibStreamHandle,
    ...
    @overload
    def CreateZLibStreamForInflate(
        zLibStreamHandle: ZLibStreamHandle, windowBits: IntType
    ) -> Tuple[ErrorCode, ZLibStreamHandle]: ...
    @staticmethod
...
class IDeflater(Protocol, IDisposable):
    ...
    def Finish(
        self, outputBuffer: ArrayType[ByteType], bytesRead: IntType
