...
from System import Array, AsyncCallback, Attribute, Boolean, Byte, Char, DateTime, Decimal, Delegate, Double, Enum, Exception, Guid, IAsyncResult, ICloneable, IDisposable, IEquatable, Int16, Int32, Int64, IntPtr, MarshalByRefObject, MulticastDelegate, Object, RuntimeFieldHandle, RuntimeMethodHandle, RuntimeTypeHandle, SByte, Single, String, SystemException, Type, TypedReference, UInt16, UInt32, UInt64, ValueType, Version, Void
from System.Collections import IEnumerator
from System.Globalization import CultureInfo
from System.IO import FileStream, Stream
from System.Reflection import Assembly, AssemblyName, Binder, BindingFlags, CallingConventions, ConstructorInfo, EventAttributes, EventInfo, FieldAttributes, FieldInfo, ICustomAttributeProvider, InterfaceMapping, ManifestResourceInfo, MemberFilter, MemberInfo, MemberTypes, MethodAttributes, MethodBase, MethodImplAttributes, MethodInfo, Module, ModuleResolveEventHandler, ParameterInfo, ParameterModifier, PropertyAttributes, PropertyInfo, StrongNameKeyPair, TypeAttributes, TypeFilter
...
from System.Runtime.InteropServices.ComTypes import ITypeInfo, ITypeLib
...
class ComSourceInterfacesAttribute(Attribute, _Attribute):
    ...
    @overload
    def __init__(self, sourceInterface1: TypeType, sourceInterface2: TypeType, sourceInterface3: TypeType): ...
    
    @overload
    def __init__(self, sourceInterface1: TypeType, sourceInterface2: TypeType, sourceInterface3: TypeType, sourceInterface4: TypeType): ...
...
class ImporterCallback(ObjectType, ITypeLibImporterNotifySink):
    ...
    def ReportEvent(self, EventKind: ImporterEventKind, EventCode: IntType, EventMsg: StringType) -> VoidType: ...
...
class Marshal(ABC, ObjectType):
    ...
    @staticmethod
    @overload
    def Copy(source: ArrayType[IntType], startIndex: IntType, destination: NIntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: ArrayType[CharType], startIndex: IntType, destination: NIntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: ArrayType[ShortType], startIndex: IntType, destination: NIntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: ArrayType[LongType], startIndex: IntType, destination: NIntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: ArrayType[FloatType], startIndex: IntType, destination: NIntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: ArrayType[DoubleType], startIndex: IntType, destination: NIntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: ArrayType[ByteType], startIndex: IntType, destination: NIntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: ArrayType[NIntType], startIndex: IntType, destination: NIntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: NIntType, destination: ArrayType[IntType], startIndex: IntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: NIntType, destination: ArrayType[CharType], startIndex: IntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: NIntType, destination: ArrayType[ShortType], startIndex: IntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: NIntType, destination: ArrayType[LongType], startIndex: IntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: NIntType, destination: ArrayType[FloatType], startIndex: IntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: NIntType, destination: ArrayType[DoubleType], startIndex: IntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: NIntType, destination: ArrayType[ByteType], startIndex: IntType, length: IntType) -> VoidType: ...
    
    @staticmethod
    @overload
    def Copy(source: NIntType, destination: ArrayType[NIntType], startIndex: IntType, length: IntType) -> VoidType: ...
    ...
    @staticmethod
    @overload
    def GetComInterfaceForObject(o: ObjectType, T: TypeType, mode: CustomQueryInterfaceMode) -> NIntType: ...
    ...
    @staticmethod
    def GetManagedThunkForUnmanagedMethodPtr(pfnMethodToWrap: NIntType, pbSignature: NIntType, cbSignature: IntType) -> NIntType: ...
    
    @staticmethod
    def GetMethodInfoForComSlot(t: TypeType, slot: IntType, memberType: ComMemberType) -> Tuple[MemberInfo, ComMemberType]: ...
    ...
    @staticmethod
    @overload
    def GetObjectsForNativeVariants(aSrcNativeVariant: NIntType, cVars: IntType) -> ArrayType[ObjectType]: ...
    
    @staticmethod
    @overload
    def GetObjectsForNativeVariants(aSrcNativeVariant: NIntType, cVars: IntType) -> ArrayType[T]: ...
    ...
    @staticmethod
    def GetTypeLibVersionForAssembly(inputAssembly: Assembly, majorVersion: IntType, minorVersion: IntType) -> Tuple[VoidType, IntType, IntType]: ...
    ...
    @staticmethod
    def GetUnmanagedThunkForManagedMethodPtr(pfnMethodToWrap: NIntType, pbSignature: NIntType, cbSignature: IntType) -> NIntType: ...
    ...
    @staticmethod
    def QueryInterface(pUnk: NIntType, iid: Guid, ppv: NIntType) -> Tuple[IntType, Guid, NIntType]: ...
    ...
    @staticmethod
    @overload
    def StructureToPtr(structure: ObjectType, ptr: NIntType, fDeleteOld: BooleanType) -> VoidType: ...
    ...
    @staticmethod
    @overload
    def WriteInt16(ptr: ObjectType, ofs: IntType, val: ShortType) -> Tuple[VoidType, ObjectType]: ...
    ...
    @staticmethod
    @overload
    def WriteIntPtr(ptr: ObjectType, ofs: IntType, val: NIntType) -> Tuple[VoidType, ObjectType]: ...
...
class ObjectCreationDelegate(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(self, aggregator: NIntType, callback: AsyncCallback, object: ObjectType) -> IAsyncResult: ...
...
class RegistrationServices(ObjectType, IRegistrationServices):
    ...
    def RegisterAssembly(self, assembly: Assembly, flags: AssemblyRegistrationFlags) -> BooleanType: ...
    
    @overload
    def RegisterTypeForComClients(self, type: TypeType, g: Guid) -> Tuple[VoidType, Guid]: ...
    
    @overload
    def RegisterTypeForComClients(self, type: TypeType, classContext: RegistrationClassContext, flags: RegistrationConnectionType) -> IntType: ...
...
class SafeBuffer(ABC, SafeHandleZeroOrMinusOneIsInvalid, IDisposable):
    ...
    def ReadArray(self, byteOffset: ULongType, array: ArrayType[T], index: IntType, count: IntType) -> VoidType: ...
    
    def ReleasePointer(self) -> VoidType: ...
    
    def Write(self, byteOffset: ULongType, value: T) -> VoidType: ...
    
    def WriteArray(self, byteOffset: ULongType, array: ArrayType[T], index: IntType, count: IntType) -> VoidType: ...
...
class SafeHeapHandleCache(ObjectType, IDisposable):
    ...
    def __init__(self, minSize: ULongType = 64, maxSize: ULongType = 2048, maxHandles: IntType): ...
...
class StringBuffer(NativeBuffer, IDisposable):
    ...
    def CopyFrom(self, bufferIndex: UIntType, source: StringType, sourceIndex: IntType, count: IntType = -1) -> VoidType: ...
    
    def CopyTo(self, bufferIndex: UIntType, destination: StringBuffer, destinationIndex: UIntType, count: UIntType) -> VoidType: ...
    ...
    def SubstringEquals(self, value: StringType, startIndex: UIntType, count: IntType = -1) -> BooleanType: ...
...
class TypeLibConverter(ObjectType, ITypeLibConverter):
    ...
    def ConvertAssemblyToTypeLib(self, assembly: Assembly, strTypeLibName: StringType, flags: TypeLibExporterFlags, notifySink: ITypeLibExporterNotifySink) -> ObjectType: ...
    
    @overload
    def ConvertTypeLibToAssembly(self, typeLib: ObjectType, asmFileName: StringType, flags: IntType, notifySink: ITypeLibImporterNotifySink, publicKey: ArrayType[ByteType], keyPair: StrongNameKeyPair, unsafeInterfaces: BooleanType) -> AssemblyBuilder: ...
    
    @overload
    def ConvertTypeLibToAssembly(self, typeLib: ObjectType, asmFileName: StringType, flags: TypeLibImporterFlags, notifySink: ITypeLibImporterNotifySink, publicKey: ArrayType[ByteType], keyPair: StrongNameKeyPair, asmNamespace: StringType, asmVersion: Version) -> AssemblyBuilder: ...
    
    def GetPrimaryInteropAssembly(self, g: Guid, major: IntType, minor: IntType, lcid: IntType, asmName: StringType, asmCodeBase: StringType) -> Tuple[BooleanType, StringType, StringType]: ...
...
class ITypeLibConverter(Protocol):
    ...
    def ConvertAssemblyToTypeLib(self, assembly: Assembly, typeLibName: StringType, flags: TypeLibExporterFlags, notifySink: ITypeLibExporterNotifySink) -> ObjectType: ...
...
class ITypeLibExporterNotifySink(Protocol):
    ...
    def ReportEvent(self, eventKind: ExporterEventKind, eventCode: IntType, eventMsg: StringType) -> VoidType: ...
...
class UCOMIBindCtx(Protocol):
    ...
    def GetRunningObjectTable(self, pprot: UCOMIRunningObjectTable) -> Tuple[VoidType, UCOMIRunningObjectTable]: ...
...
class UCOMIConnectionPoint(Protocol):
    ...
    def EnumConnections(self, ppEnum: UCOMIEnumConnections) -> Tuple[VoidType, UCOMIEnumConnections]: ...
    
    def GetConnectionInterface(self, pIID: Guid) -> Tuple[VoidType, Guid]: ...
    
    def GetConnectionPointContainer(self, ppCPC: UCOMIConnectionPointContainer) -> Tuple[VoidType, UCOMIConnectionPointContainer]: ...
...
class UCOMIConnectionPointContainer(Protocol):
    ...
    def EnumConnectionPoints(self, ppEnum: UCOMIEnumConnectionPoints) -> Tuple[VoidType, UCOMIEnumConnectionPoints]: ...
    
    def FindConnectionPoint(self, riid: Guid, ppCP: UCOMIConnectionPoint) -> Tuple[VoidType, Guid, UCOMIConnectionPoint]: ...
...
class UCOMIEnumConnectionPoints(Protocol):
    ...
    def Clone(self, ppenum: UCOMIEnumConnectionPoints) -> Tuple[VoidType, UCOMIEnumConnectionPoints]: ...
    
    def Next(self, celt: IntType, rgelt: ArrayType[UCOMIConnectionPoint], pceltFetched: IntType) -> Tuple[IntType, ArrayType[UCOMIConnectionPoint], IntType]: ...
...
class UCOMIEnumConnections(Protocol):
    ...
    def Next(self, celt: IntType, rgelt: ArrayType[CONNECTDATA], pceltFetched: IntType) -> Tuple[IntType, ArrayType[CONNECTDATA], IntType]: ...
...
class UCOMIEnumMoniker(Protocol):
    ...
    def Next(self, celt: IntType, rgelt: ArrayType[UCOMIMoniker], pceltFetched: IntType) -> Tuple[IntType, ArrayType[UCOMIMoniker], IntType]: ...
...
class UCOMIEnumString(Protocol):
    ...
    def Next(self, celt: IntType, rgelt: ArrayType[StringType], pceltFetched: IntType) -> Tuple[IntType, ArrayType[StringType], IntType]: ...
...
class UCOMIMoniker(Protocol):
    ...
    def BindToObject(self, pbc: UCOMIBindCtx, pmkToLeft: UCOMIMoniker, riidResult: Guid, ppvResult: ObjectType) -> Tuple[VoidType, Guid, ObjectType]: ...
    
    def BindToStorage(self, pbc: UCOMIBindCtx, pmkToLeft: UCOMIMoniker, riid: Guid, ppvObj: ObjectType) -> Tuple[VoidType, Guid, ObjectType]: ...
    
    def CommonPrefixWith(self, pmkOther: UCOMIMoniker, ppmkPrefix: UCOMIMoniker) -> Tuple[VoidType, UCOMIMoniker]: ...
    
    def ComposeWith(self, pmkRight: UCOMIMoniker, fOnlyIfNotGeneric: BooleanType, ppmkComposite: UCOMIMoniker) -> Tuple[VoidType, UCOMIMoniker]: ...
    
    def Enum(self, fForward: BooleanType, ppenumMoniker: UCOMIEnumMoniker) -> Tuple[VoidType, UCOMIEnumMoniker]: ...
    
    def GetClassID(self, pClassID: Guid) -> Tuple[VoidType, Guid]: ...
    
    def GetDisplayName(self, pbc: UCOMIBindCtx, pmkToLeft: UCOMIMoniker, ppszDisplayName: StringType) -> Tuple[VoidType, StringType]: ...
    
    def GetSizeMax(self, pcbSize: LongType) -> Tuple[VoidType, LongType]: ...
    
    def GetTimeOfLastChange(self, pbc: UCOMIBindCtx, pmkToLeft: UCOMIMoniker, pFileTime: FILETIME) -> Tuple[VoidType, FILETIME]: ...
    ...
    def IsRunning(self, pbc: UCOMIBindCtx, pmkToLeft: UCOMIMoniker, pmkNewlyRunning: UCOMIMoniker) -> VoidType: ...
    
    def IsSystemMoniker(self, pdwMksys: IntType) -> Tuple[VoidType, IntType]: ...
    
    def Load(self, pStm: UCOMIStream) -> VoidType: ...
    
    def ParseDisplayName(self, pbc: UCOMIBindCtx, pmkToLeft: UCOMIMoniker, pszDisplayName: StringType, pchEaten: IntType, ppmkOut: UCOMIMoniker) -> Tuple[VoidType, IntType, UCOMIMoniker]: ...
    
    def Reduce(self, pbc: UCOMIBindCtx, dwReduceHowFar: IntType, ppmkToLeft: UCOMIMoniker, ppmkReduced: UCOMIMoniker) -> Tuple[VoidType, UCOMIMoniker, UCOMIMoniker]: ...
    
    def RelativePathTo(self, pmkOther: UCOMIMoniker, ppmkRelPath: UCOMIMoniker) -> Tuple[VoidType, UCOMIMoniker]: ...
...
class UCOMIRunningObjectTable(Protocol):
    ...
    def GetObject(self, pmkObjectName: UCOMIMoniker, ppunkObject: ObjectType) -> Tuple[VoidType, ObjectType]: ...
    
    def GetTimeOfLastChange(self, pmkObjectName: UCOMIMoniker, pfiletime: FILETIME) -> Tuple[VoidType, FILETIME]: ...
    ...
    def Register(self, grfFlags: IntType, punkObject: ObjectType, pmkObjectName: UCOMIMoniker, pdwRegister: IntType) -> Tuple[VoidType, IntType]: ...
...
class UCOMIStream(Protocol):
    ...
    def CopyTo(self, pstm: UCOMIStream, cb: LongType, pcbRead: NIntType, pcbWritten: NIntType) -> VoidType: ...
...
class UCOMITypeComp(Protocol):
    ...
    def Bind(self, szName: StringType, lHashVal: IntType, wFlags: ShortType, ppTInfo: UCOMITypeInfo, pDescKind: DESCKIND, pBindPtr: BINDPTR) -> Tuple[VoidType, UCOMITypeInfo, DESCKIND, BINDPTR]: ...
    
    def BindType(self, szName: StringType, lHashVal: IntType, ppTInfo: UCOMITypeInfo, ppTComp: UCOMITypeComp) -> Tuple[VoidType, UCOMITypeInfo, UCOMITypeComp]: ...
...
class UCOMITypeInfo(Protocol):
    ...
    def GetContainingTypeLib(self, ppTLB: UCOMITypeLib, pIndex: IntType) -> Tuple[VoidType, UCOMITypeLib, IntType]: ...
    
    def GetDllEntry(self, memid: IntType, invKind: INVOKEKIND, pBstrDllName: StringType, pBstrName: StringType, pwOrdinal: ShortType) -> Tuple[VoidType, StringType, StringType, ShortType]: ...
    ...
    def GetImplTypeFlags(self, index: IntType, pImplTypeFlags: IntType) -> Tuple[VoidType, IntType]: ...
    ...
    def GetRefTypeInfo(self, hRef: IntType, ppTI: UCOMITypeInfo) -> Tuple[VoidType, UCOMITypeInfo]: ...
    ...
    def Invoke(self, pvInstance: ObjectType, memid: IntType, wFlags: ShortType, pDispParams: DISPPARAMS, pVarResult: ObjectType, pExcepInfo: EXCEPINFO, puArgErr: IntType) -> Tuple[VoidType, DISPPARAMS, ObjectType, EXCEPINFO, IntType]: ...
...
class UCOMITypeLib(Protocol):
    ...
    def FindName(self, szNameBuf: StringType, lHashVal: IntType, ppTInfo: ArrayType[UCOMITypeInfo], rgMemId: ArrayType[IntType], pcFound: ShortType) -> Tuple[VoidType, ArrayType[UCOMITypeInfo], ArrayType[IntType], ShortType]: ...
    ...
    def GetTypeInfo(self, index: IntType, ppTI: UCOMITypeInfo) -> Tuple[VoidType, UCOMITypeInfo]: ...
    
    def GetTypeInfoCount(self) -> IntType: ...
    
    def GetTypeInfoOfGuid(self, guid: Guid, ppTInfo: UCOMITypeInfo) -> Tuple[VoidType, Guid, UCOMITypeInfo]: ...
...
class _ConstructorInfo(Protocol):
    ...
    def Invoke_2(self, obj: ObjectType, invokeAttr: BindingFlags, binder: Binder, parameters: ArrayType[ObjectType], culture: CultureInfo) -> ObjectType: ...
    
    def Invoke_3(self, obj: ObjectType, parameters: ArrayType[ObjectType]) -> ObjectType: ...
    
    def Invoke_4(self, invokeAttr: BindingFlags, binder: Binder, parameters: ArrayType[ObjectType], culture: CultureInfo) -> ObjectType: ...
