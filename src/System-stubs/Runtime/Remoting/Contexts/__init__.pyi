...
class Context(ObjectType):
    ...
    def RegisterDynamicProperty(
        prop: IDynamicProperty, obj: ContextBoundObject, ctx: Context
    ) -> BooleanType: ...
    @staticmethod
    ...
    @staticmethod
    def UnregisterDynamicProperty(
        name: StringType, obj: ContextBoundObject, ctx: Context
    ) -> BooleanType: ...
...
class IContextPropertyActivator(Protocol):
    ...
    def DeliverServerContextToClientContext(
        self, msg: IConstructionReturnMessage
    ) -> BooleanType: ...
...
class IDynamicMessageSink(Protocol):
    ...
    def ProcessMessageFinish(
        self, replyMsg: IMessage, bCliSide: BooleanType, bAsync: BooleanType
    ) -> VoidType: ...
    def ProcessMessageStart(
        self, reqMsg: IMessage, bCliSide: BooleanType, bAsync: BooleanType
    ) -> VoidType: ...
