...
class Assembly(
    ABC, ObjectType, _Assembly, IEvidenceFactory, ICustomAttributeProvider, ISerializable
):
    # No Fields
...
class ConstructorInfo(
    ABC, MethodBase, ICustomAttributeProvider, _MemberInfo, _MethodBase, _ConstructorInfo
):
    # ---------- Fields ---------- #
...
class CustomAttributeExtensions(ABC, ObjectType):
    ...
    @overload
    def GetCustomAttributes(
        element: MemberInfo, inherit: BooleanType
    ...
    @overload
    def GetCustomAttributes(
        element: Assembly, attributeType: TypeType
    ) -> IEnumerable[Attribute]: ...
    @staticmethod
    @overload
    ...
    @overload
    def GetCustomAttributes(
        element: MemberInfo, attributeType: TypeType
    ) -> IEnumerable[Attribute]: ...
    @staticmethod
    @overload
    def GetCustomAttributes(
...
class FieldInfo(ABC, MemberInfo, ICustomAttributeProvider, _MemberInfo, _FieldInfo):
    ...
    def GetFieldFromHandle(
        handle: RuntimeFieldHandle, declaringType: RuntimeTypeHandle
    ) -> FieldInfo: ...
    def GetHashCode(self) -> IntType: ...
...
class MdConstant(ABC, ObjectType):
    ...
    @staticmethod
    def GetValue(
        scope: MetadataImport, token: IntType, fieldTypeHandle: RuntimeTypeHandle, raw: BooleanType
    ) -> ObjectType: ...
...
class MdFieldInfo(
    RuntimeFieldInfo, ICustomAttributeProvider, _MemberInfo, _FieldInfo, ISerializable
):
    # No Fields
...
class MemberFilter(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(
        self, m: MemberInfo, filterCriteria: ObjectType, callback: AsyncCallback, object: ObjectType
    ) -> IAsyncResult: ...
...
class MemberInfoSerializationHolder(ObjectType, ISerializable, IObjectReference):
    ...
    def GetSerializationInfo(
        ...
        reflectedClass: RuntimeType,
        signature: StringType,
        signature2: StringType,
        type: MemberTypes,
        genericArguments: ArrayType[TypeType],
    ) -> VoidType: ...
...
class MethodBase(ABC, MemberInfo, ICustomAttributeProvider, _MemberInfo, _MethodBase):
    ...
    def GetMethodFromHandle(
        handle: RuntimeMethodHandle, declaringType: RuntimeTypeHandle
    ) -> MethodBase: ...
...
class ModuleResolveEventHandler(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(
        self, sender: ObjectType, e: ResolveEventArgs, callback: AsyncCallback, object: ObjectType
    ) -> IAsyncResult: ...
...
class ReflectionTypeLoadException(SystemException, ISerializable, _Exception):
    ...
    @overload
    def __init__(
        self, classes: ArrayType[TypeType], exceptions: ArrayType[Exception], message: StringType
    ): ...
...
class RuntimeFieldInfo(
    ABC, FieldInfo, ICustomAttributeProvider, _MemberInfo, _FieldInfo, ISerializable
):
    # No Fields
...
class RuntimeParameterInfo(
    ParameterInfo, _ParameterInfo, ICustomAttributeProvider, IObjectReference, ISerializable
):
    # No Fields
...
class RuntimeReflectionExtensions(ABC, ObjectType):
    ...
    def GetRuntimeMethod(
        type: TypeType, name: StringType, parameters: ArrayType[TypeType]
    ) -> MethodInfo: ...
    @staticmethod
...
class TypeFilter(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(
        self, m: TypeType, filterCriteria: ObjectType, callback: AsyncCallback, object: ObjectType
    ) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> BooleanType: ...
...
class TypeInfo(
    ABC, TypeType, ICustomAttributeProvider, _MemberInfo, _Type, IReflect, IReflectableType
):
    # No Fields
...
class __Filters(ObjectType):
    ...
    def FilterTypeNameIgnoreCase(
        self, cls: TypeType, filterCriteria: ObjectType
    ) -> BooleanType: ...
...
class CustomAttributeNamedArgument(ValueType):
    ...
    @staticmethod
    def op_Equality(
        left: CustomAttributeNamedArgument, right: CustomAttributeNamedArgument
    ) -> BooleanType: ...
    @staticmethod
    def op_Inequality(
        left: CustomAttributeNamedArgument, right: CustomAttributeNamedArgument
...
class CustomAttributeTypedArgument(ValueType):
    ...
    @staticmethod
    def op_Equality(
        left: CustomAttributeTypedArgument, right: CustomAttributeTypedArgument
    ) -> BooleanType: ...
    @staticmethod
    def op_Inequality(
        left: CustomAttributeTypedArgument, right: CustomAttributeTypedArgument
...
class MetadataEnumResult(ValueType):
    ...
    class e__FixedBuffer(ValueType):
        # ---------- Fields ---------- #
...
class MetadataImport(ValueType):
    ...
    def Enum(
        self, type: MetadataTokenType, parent: IntType, result: MetadataEnumResult
    ) -> Tuple[VoidType, MetadataEnumResult]: ...
    def EnumCustomAttributes(
        self, mdToken: IntType, result: MetadataEnumResult
    ) -> Tuple[VoidType, MetadataEnumResult]: ...
    def EnumEvents(
        self, mdTypeDef: IntType, result: MetadataEnumResult
    ) -> Tuple[VoidType, MetadataEnumResult]: ...
    def EnumFields(
        self, mdTypeDef: IntType, result: MetadataEnumResult
    ) -> Tuple[VoidType, MetadataEnumResult]: ...
    ...
    def EnumParams(
        self, mdMethodDef: IntType, result: MetadataEnumResult
    ) -> Tuple[VoidType, MetadataEnumResult]: ...
    def EnumProperties(
        self, mdTypeDef: IntType, result: MetadataEnumResult
    ) -> Tuple[VoidType, MetadataEnumResult]: ...
    def Equals(self, obj: ObjectType) -> BooleanType: ...
    def GetClassLayout(
        self, typeTokenDef: IntType, packSize: IntType, classSize: IntType
    ) -> Tuple[VoidType, IntType, IntType]: ...
    def GetCustomAttributeProps(
        self, customAttributeToken: IntType, constructorToken: IntType, signature: ConstArray
    ) -> Tuple[VoidType, IntType, ConstArray]: ...
    def GetDefaultValue(
        self, mdToken: IntType, value: LongType, length: IntType, corElementType: CorElementType
    ) -> Tuple[StringType, LongType, IntType, CorElementType]: ...
    def GetEventProps(
        self, mdToken: IntType, name: VoidType, eventAttributes: EventAttributes
    ) -> Tuple[VoidType, VoidType, EventAttributes]: ...
    def GetFieldDefProps(
        self, mdToken: IntType, fieldAttributes: FieldAttributes
    ) -> Tuple[VoidType, FieldAttributes]: ...
    def GetFieldMarshal(self, fieldToken: IntType) -> ConstArray: ...
    def GetFieldOffset(
        self, typeTokenDef: IntType, fieldTokenDef: IntType, offset: IntType
    ) -> Tuple[BooleanType, IntType]: ...
    def GetGenericParamProps(
        self, genericParameter: IntType, attributes: GenericParameterAttributes
    ) -> Tuple[VoidType, GenericParameterAttributes]: ...
    def GetHashCode(self) -> IntType: ...
    ...
    def GetPInvokeMap(
        ...
        importName: StringType,
        importDll: StringType,
    ) -> Tuple[VoidType, PInvokeAttributes, StringType, StringType]: ...
    def GetParamDefProps(
        self, parameterToken: IntType, sequence: IntType, attributes: ParameterAttributes
    ) -> Tuple[VoidType, IntType, ParameterAttributes]: ...
    ...
    ) -> Tuple[VoidType, VoidType, PropertyAttributes, ConstArray]: ...
