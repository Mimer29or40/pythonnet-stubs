...
from System.Configuration import BaseConfigurationRecord
from System.Configuration import Configuration
from System.Configuration import ConfigurationAllowDefinition
from System.Configuration import ConfigurationAllowExeDefinition
from System.Configuration import ConfigurationBuilder
from System.Configuration import ConfigurationSection
from System.Configuration import ProtectedConfigurationProvider
from System.Configuration import ProtectedConfigurationSection
...
class DelegatingConfigHost(ObjectType, IInternalConfigHost, IInternalConfigurationBuilderHost):
    ...
    def EncryptSection(
        self,
        clearTextXml: StringType,
        protectionProvider: ProtectedConfigurationProvider,
        protectedConfigSection: ProtectedConfigurationSection,
    ) -> StringType: ...
    def GetConfigPathFromLocationSubPath(
        self, configPath: StringType, locationSubPath: StringType
    ) -> StringType: ...
    ...
    def IsFullTrustSectionWithoutAptcaAllowed(
        self, configRecord: IInternalConfigRecord
    ) -> BooleanType: ...
    ...
    @overload
    def OpenStreamForRead(
        self, streamName: StringType, assertPermissions: BooleanType
    ) -> Stream: ...
    @overload
    ...
    def OpenStreamForWrite(
        ...
        templateStreamName: StringType,
        writeContext: ObjectType,
        assertPermissions: BooleanType,
    ) -> Tuple[Stream, ObjectType]: ...
    ...
    def ProcessConfigurationSection(
        self, configSection: ConfigurationSection, builder: ConfigurationBuilder
    ...
    def StartMonitoringStreamForChanges(
        self, streamName: StringType, callback: StreamChangeCallback
    ) -> ObjectType: ...
    def StopMonitoringStreamForChanges(
        self, streamName: StringType, callback: StreamChangeCallback
    ) -> VoidType: ...
...
class StreamChangeCallback(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(
        self, streamName: StringType, callback: AsyncCallback, object: ObjectType
    ) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> VoidType: ...
...
class IInternalConfigConfigurationFactory(Protocol):
    ...
    def Create(
        self, typeConfigHost: TypeType, hostInitConfigurationParams: ArrayType[ObjectType]
    ) -> Configuration: ...
    def NormalizeLocationSubPath(
        self, subPath: StringType, errorInfo: IConfigErrorInfo
    ) -> StringType: ...
...
class IInternalConfigSettingsFactory(Protocol):
    ...
    def SetConfigurationSystem(
        self, internalConfigSystem: IInternalConfigSystem, initComplete: BooleanType
    ) -> VoidType: ...
