...
class XPathDocumentBuilder(XmlRawWriter, IDisposable):
    ...
    def __init__(
        self, doc: XPathDocument, lineInfo: IXmlLineInfo, baseUri: StringType, flags: LoadFlags
    ): ...
    ...
    def WriteDocType(
        self, name: StringType, pubid: StringType, sysid: StringType, subset: StringType
    ) -> VoidType: ...
    ...
    def WriteProcessingInstruction(
        self, name: StringType, text: StringType, baseUri: StringType
    ) -> VoidType: ...
    @overload
    ...
    @overload
    def WriteStartAttribute(
        self, prefix: StringType, localName: StringType, namespaceName: StringType
    ) -> VoidType: ...
    @overload
    def WriteStartElement(
        self, prefix: StringType, localName: StringType, ns: StringType
    ) -> VoidType: ...
    @overload
    def WriteStartElement(
        self, prefix: StringType, localName: StringType, ns: StringType, baseUri: StringType
    ) -> VoidType: ...
    @overload
...
class XPathDocumentElementChildIterator(XPathDocumentBaseIterator, ICloneable, IEnumerable):
    ...
    @overload
    def __init__(
        self, parent: XPathDocumentNavigator, name: StringType, namespaceURI: StringType
    ): ...
    @overload
...
class XPathDocumentKindDescendantIterator(XPathDocumentBaseIterator, ICloneable, IEnumerable):
    ...
    @overload
    def __init__(
        self, root: XPathDocumentNavigator, typ: XPathNodeType, matchSelf: BooleanType
    ): ...
    @overload
...
class XPathDocumentNavigator(
    XPathNavigator, ICloneable, IXPathNavigable, IXmlNamespaceResolver, IXmlLineInfo
):
    # No Fields
    ...
    def __init__(
        self,
        pageCurrent: ArrayType[XPathNode],
        idxCurrent: IntType,
        pageParent: ArrayType[XPathNode],
        idxParent: IntType,
    ): ...
    @overload
    ...
    @overload
    def MoveToFollowing(
        self, localName: StringType, namespaceURI: StringType, end: XPathNavigator
    ) -> BooleanType: ...
    @overload
    ...
    def SelectDescendants(
        self, type: XPathNodeType, matchSelf: BooleanType
    ) -> XPathNodeIterator: ...
    @overload
    def SelectDescendants(
        self, name: StringType, namespaceURI: StringType, matchSelf: BooleanType
    ) -> XPathNodeIterator: ...
...
class XPathNodeHelper(ABC, ObjectType):
    ...
    @staticmethod
    def GetAttribute(
        pageNode: XPathNode, idxNode: IntType, localName: StringType, namespaceName: StringType
    ) -> Tuple[BooleanType, XPathNode, IntType]: ...
    @staticmethod
    @overload
    def GetContentChild(
        pageNode: XPathNode, idxNode: IntType
    ) -> Tuple[BooleanType, XPathNode, IntType]: ...
    @staticmethod
    @overload
    def GetContentChild(
        pageNode: XPathNode, idxNode: IntType, typ: XPathNodeType
    ) -> Tuple[BooleanType, XPathNode, IntType]: ...
    @staticmethod
    def GetContentFollowing(
        pageCurrent: XPathNode,
        idxCurrent: IntType,
        pageEnd: ArrayType[XPathNode],
        idxEnd: IntType,
        typ: XPathNodeType,
    ) -> Tuple[BooleanType, XPathNode, IntType]: ...
    @staticmethod
    @overload
    def GetContentSibling(
        pageNode: XPathNode, idxNode: IntType
    ) -> Tuple[BooleanType, XPathNode, IntType]: ...
    @staticmethod
    @overload
    ...
    @staticmethod
    def GetInScopeNamespaces(
        pageElem: ArrayType[XPathNode], idxElem: IntType, pageNmsp: XPathNode
    ) -> Tuple[IntType, XPathNode]: ...
    @staticmethod
    def GetLocalNamespaces(
        pageElem: ArrayType[XPathNode], idxElem: IntType, pageNmsp: XPathNode
    ) -> Tuple[IntType, XPathNode]: ...
    @staticmethod
    def GetLocation(pageNode: ArrayType[XPathNode], idxNode: IntType) -> IntType: ...
    @staticmethod
    def GetNextAttribute(
        pageNode: XPathNode, idxNode: IntType
    ) -> Tuple[BooleanType, XPathNode, IntType]: ...
    @staticmethod
    def GetNonDescendant(
        pageNode: XPathNode, idxNode: IntType
    ) -> Tuple[BooleanType, XPathNode, IntType]: ...
    @staticmethod
    def GetParent(
    ...
    @staticmethod
    def GetTextFollowing(
        pageCurrent: XPathNode, idxCurrent: IntType, pageEnd: ArrayType[XPathNode], idxEnd: IntType
    ) -> Tuple[BooleanType, XPathNode, IntType]: ...
...
class XPathNodeInfoAtom(ObjectType):
    ...
    def __init__(
        ...
        baseUri: StringType,
        pageParent: ArrayType[XPathNode],
        pageSibling: ArrayType[XPathNode],
        pageSimilar: ArrayType[XPathNode],
        doc: XPathDocument,
        lineNumBase: IntType,
        linePosBase: IntType,
    ): ...
...
class XPathNode(ValueType):
    ...
    @overload
    def Create(
        self, info: XPathNodeInfoAtom, xptyp: XPathNodeType, idxParent: IntType
    ) -> VoidType: ...
    ...
    def SetSibling(
        self, infoTable: XPathNodeInfoTable, pageSibling: ArrayType[XPathNode], idxSibling: IntType
    ) -> VoidType: ...
    def SetSimilarElement(
        self, infoTable: XPathNodeInfoTable, pageSimilar: ArrayType[XPathNode], idxSimilar: IntType
    ) -> VoidType: ...
