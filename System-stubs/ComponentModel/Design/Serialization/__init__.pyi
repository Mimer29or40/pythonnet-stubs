...
from System.ComponentModel import IContainer, MemberDescriptor, PropertyDescriptorCollection
from System.ComponentModel.Design import IDesignerHost, IServiceContainer
...
class ComponentSerializationService(ABC, ObjectType):
    ...
    @overload
    def DeserializeTo(self, store: SerializationStore, container: IContainer, validateRecycledTypes: BooleanType) -> VoidType: ...
    
    @overload
    def DeserializeTo(self, store: SerializationStore, container: IContainer, validateRecycledTypes: BooleanType, applyDefaults: BooleanType) -> VoidType: ...
    ...
    def SerializeMember(self, store: SerializationStore, owningObject: ObjectType, member: MemberDescriptor) -> VoidType: ...
    
    def SerializeMemberAbsolute(self, store: SerializationStore, owningObject: ObjectType, member: MemberDescriptor) -> VoidType: ...
...
class MemberRelationshipService(ABC, ObjectType):
    ...
    def SupportsRelationship(self, source: MemberRelationship, relationship: MemberRelationship) -> BooleanType: ...
    
    @overload
    def get_Item(self, source: MemberRelationship) -> MemberRelationship: ...
    
    @overload
    def get_Item(self, sourceOwner: ObjectType, sourceMember: MemberDescriptor) -> MemberRelationship: ...
    
    @overload
    def set_Item(self, source: MemberRelationship, value: MemberRelationship) -> VoidType: ...
    
    @overload
    def set_Item(self, sourceOwner: ObjectType, sourceMember: MemberDescriptor, value: MemberRelationship) -> VoidType: ...
...
class ResolveNameEventHandler(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(self, sender: ObjectType, e: ResolveNameEventArgs, callback: AsyncCallback, object: ObjectType) -> IAsyncResult: ...
...
class RootDesignerSerializerAttribute(Attribute, _Attribute):
    ...
    @overload
    def __init__(self, serializerType: TypeType, baseSerializerType: TypeType, reloadable: BooleanType): ...
    
    @overload
    def __init__(self, serializerTypeName: StringType, baseSerializerType: TypeType, reloadable: BooleanType): ...
    
    @overload
    def __init__(self, serializerTypeName: StringType, baseSerializerTypeName: StringType, reloadable: BooleanType): ...
...
class IDesignerLoaderHost(Protocol, IDesignerHost, IServiceContainer, IServiceProvider):
    ...
    def EndLoad(self, baseClassName: StringType, successful: BooleanType, errorCollection: ICollection) -> VoidType: ...
...
class IDesignerLoaderHost2(Protocol, IDesignerLoaderHost, IDesignerHost, IServiceContainer, IServiceProvider):
    # ---------- Properties ---------- #
...
class IDesignerLoaderService(Protocol):
    ...
    def DependentLoadComplete(self, successful: BooleanType, errorCollection: ICollection) -> VoidType: ...
...
class IDesignerSerializationManager(Protocol, IServiceProvider):
    ...
    def CreateInstance(self, type: TypeType, arguments: ICollection, name: StringType, addToContainer: BooleanType) -> ObjectType: ...
...
class IDesignerSerializationProvider(Protocol):
    ...
    def GetSerializer(self, manager: IDesignerSerializationManager, currentSerializer: ObjectType, objectType: TypeType, serializerType: TypeType) -> ObjectType: ...
