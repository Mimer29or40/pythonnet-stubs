...
from System import Array, Boolean, Enum, Int32, Object, String, Type, Void
...
class SoapFault(ObjectType, ISerializable):
    ...
    @overload
    def __init__(self, faultCode: StringType, faultString: StringType, faultActor: StringType, serverFault: ServerFault): ...
