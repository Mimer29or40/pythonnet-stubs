...
from System import Array, Boolean, Enum, Exception, IAsyncResult, Int32, MarshalByRefObject, Object, String, ValueType, Void
...
class BaseChannelSinkWithProperties(ABC, BaseChannelObjectWithProperties, IDictionary, ICollection, IEnumerable):
    """"""
...
class BaseChannelWithProperties(ABC, BaseChannelObjectWithProperties, IDictionary, ICollection, IEnumerable):
    # No Fields
...
class ChannelServices(ObjectType):
    ...
    @staticmethod
    def DispatchMessage(sinkStack: IServerChannelSinkStack, msg: IMessage, replyMsg: IMessage) -> Tuple[ServerProcessing, IMessage]: ...
...
class CrossAppDomainChannel(ObjectType, IChannel, IChannelSender, IChannelReceiver):
    ...
    def CreateMessageSink(self, url: StringType, data: ObjectType, objectURI: StringType) -> Tuple[IMessageSink, StringType]: ...
...
class DispatchChannelSink(ObjectType, IServerChannelSink, IChannelSinkBase):
    ...
    def AsyncProcessResponse(self, sinkStack: IServerResponseChannelSinkStack, state: ObjectType, msg: IMessage, headers: ITransportHeaders, stream: Stream) -> VoidType: ...
    
    def GetResponseStream(self, sinkStack: IServerResponseChannelSinkStack, state: ObjectType, msg: IMessage, headers: ITransportHeaders) -> Stream: ...
    
    def ProcessMessage(self, sinkStack: IServerChannelSinkStack, requestMsg: IMessage, requestHeaders: ITransportHeaders, requestStream: Stream, responseMsg: IMessage, responseHeaders: ITransportHeaders, responseStream: Stream) -> Tuple[ServerProcessing, IMessage, ITransportHeaders, Stream]: ...
...
class ServerChannelSinkStack(ObjectType, IServerChannelSinkStack, IServerResponseChannelSinkStack):
    ...
    def AsyncProcessResponse(self, msg: IMessage, headers: ITransportHeaders, stream: Stream) -> VoidType: ...
...
class IChannelSender(Protocol, IChannel):
    ...
    def CreateMessageSink(self, url: StringType, remoteChannelData: ObjectType, objectURI: StringType) -> Tuple[IMessageSink, StringType]: ...
...
class IClientChannelSink(Protocol, IChannelSinkBase):
    ...
    def AsyncProcessRequest(self, sinkStack: IClientChannelSinkStack, msg: IMessage, headers: ITransportHeaders, stream: Stream) -> VoidType: ...
    
    def AsyncProcessResponse(self, sinkStack: IClientResponseChannelSinkStack, state: ObjectType, headers: ITransportHeaders, stream: Stream) -> VoidType: ...
    
    def GetRequestStream(self, msg: IMessage, headers: ITransportHeaders) -> Stream: ...
    
    def ProcessMessage(self, msg: IMessage, requestHeaders: ITransportHeaders, requestStream: Stream, responseHeaders: ITransportHeaders, responseStream: Stream) -> Tuple[VoidType, ITransportHeaders, Stream]: ...
...
class IClientChannelSinkProvider(Protocol):
    ...
    def CreateSink(self, channel: IChannelSender, url: StringType, remoteChannelData: ObjectType) -> IClientChannelSink: ...
