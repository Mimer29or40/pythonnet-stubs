...
from System import Array, AsyncCallback, Attribute, Boolean, Exception, IAsyncResult, ICloneable, Int32, IntPtr, MarshalByRefObject, MulticastDelegate, Object, RuntimeMethodHandle, String, Type, Void
from System.Collections import DictionaryEntry, ICollection, IDictionary, IDictionaryEnumerator, IEnumerable, IEnumerator, IList
from System.IO import Stream
from System.Reflection import MethodBase
from System.Runtime.InteropServices import _Attribute
from System.Runtime.Remoting import Identity, ObjRef, ServerIdentity
from System.Runtime.Remoting.Activation import IActivator, IConstructionCallMessage, IConstructionReturnMessage
from System.Runtime.Serialization import IFormatter, ISerializable, ISerializationSurrogate, ISurrogateSelector, SerializationInfo, StreamingContext
...
class ConstructionCall(MethodCall, IMethodCallMessage, IMethodMessage, IMessage, ISerializable, IInternalMessage, ISerializationRootObject, IConstructionCallMessage):
    # No Fields
...
class ConstructionResponse(MethodResponse, IMethodReturnMessage, IMethodMessage, IMessage, ISerializable, ISerializationRootObject, IInternalMessage, IConstructionReturnMessage):
    # No Fields
...
class ConstructorCallMessage(ObjectType, IConstructionCallMessage, IMethodCallMessage, IMethodMessage, IMessage):
    # No Fields
...
class ConstructorReturnMessage(ReturnMessage, IMethodReturnMessage, IMethodMessage, IMessage, IConstructionReturnMessage):
    # No Fields
    
    # ---------- Constructors ---------- #
    
    @overload
    def __init__(self, o: MarshalByRefObject, outArgs: ArrayType[ObjectType], outArgsCount: IntType, callCtx: LogicalCallContext, ccm: IConstructionCallMessage): ...
...
class Header(ObjectType):
    ...
    @overload
    def __init__(self, _Name: StringType, _Value: ObjectType, _MustUnderstand: BooleanType, _HeaderNamespace: StringType): ...
...
class HeaderHandler(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(self, headers: ArrayType[Header], callback: AsyncCallback, object: ObjectType) -> IAsyncResult: ...
...
class Message(ObjectType, IMethodCallMessage, IMethodMessage, IMessage, IInternalMessage, ISerializable):
    # No Fields
    ...
    def GetAsyncBeginInfo(self, acbd: AsyncCallback, state: ObjectType) -> Tuple[VoidType, AsyncCallback, ObjectType]: ...
    ...
    def PropagateOutParameters(self, OutArgs: ArrayType[ObjectType], retVal: ObjectType) -> VoidType: ...
...
class MessageSurrogateFilter(MulticastDelegate, ICloneable, ISerializable):
    ...
    def BeginInvoke(self, key: StringType, value: ObjectType, callback: AsyncCallback, object: ObjectType) -> IAsyncResult: ...
...
class MethodCall(ObjectType, IMethodCallMessage, IMethodMessage, IMessage, ISerializable, IInternalMessage, ISerializationRootObject):
    # No Fields
...
class MethodCallMessageWrapper(InternalMessageWrapper, IMethodCallMessage, IMethodMessage, IMessage):
    # No Fields
...
class MethodResponse(ObjectType, IMethodReturnMessage, IMethodMessage, IMessage, ISerializable, ISerializationRootObject, IInternalMessage):
    # No Fields
...
class MethodReturnMessageWrapper(InternalMessageWrapper, IMethodReturnMessage, IMethodMessage, IMessage):
    # No Fields
...
class RemotingSurrogateSelector(ObjectType, ISurrogateSelector):
    ...
    def GetSurrogate(self, type: TypeType, context: StreamingContext, ssout: ISurrogateSelector) -> Tuple[ISerializationSurrogate, ISurrogateSelector]: ...
...
class ReturnMessage(ObjectType, IMethodReturnMessage, IMethodMessage, IMessage):
    ...
    @overload
    def __init__(self, ret: ObjectType, outArgs: ArrayType[ObjectType], outArgsCount: IntType, callCtx: LogicalCallContext, mcm: IMethodCallMessage): ...
...
class StackBasedReturnMessage(ObjectType, IMethodReturnMessage, IMethodMessage, IMessage, IInternalMessage):
    # No Fields
...
class StackBuilderSink(ObjectType, IMessageSink):
    ...
    def PrivateProcessMessage(self, md: RuntimeMethodHandle, args: ArrayType[ObjectType], server: ObjectType, outArgs: ObjectType) -> Tuple[ObjectType, ObjectType]: ...
