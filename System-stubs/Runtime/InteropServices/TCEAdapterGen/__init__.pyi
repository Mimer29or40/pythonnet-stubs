...
class EventItfInfo(ObjectType):
    ...
    def __init__(self, strEventItfName: StringType, strSrcItfName: StringType, strEventProviderName: StringType, asmImport: RuntimeAssembly, asmSrcItf: RuntimeAssembly): ...
...
class EventProviderWriter(ObjectType):
    ...
    def __init__(self, OutputModule: ModuleBuilder, strDestTypeName: StringType, EventItfType: TypeType, SrcItfType: TypeType, SinkHelperType: TypeType): ...
...
class EventSinkHelperWriter(ObjectType):
    ...
    def __init__(self, OutputModule: ModuleBuilder, InputType: TypeType, EventItfType: TypeType): ...
