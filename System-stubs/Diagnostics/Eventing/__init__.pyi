...
from System import Array, Boolean, Byte, Enum, Guid, IDisposable, Int32, Int64, Object, String, ValueType, Void
from System.Diagnostics import TraceEventCache, TraceEventType, TraceListener
...
class EventProvider(ObjectType, IDisposable):
    ...
    @overload
    def WriteEvent(self, eventDescriptor: EventDescriptor, eventPayload: ArrayType[ObjectType]) -> Tuple[BooleanType, EventDescriptor]: ...
    
    @overload
    def WriteEvent(self, eventDescriptor: EventDescriptor, data: StringType) -> Tuple[BooleanType, EventDescriptor]: ...
    
    @overload
    def WriteMessageEvent(self, eventMessage: StringType, eventLevel: ByteType, eventKeywords: LongType) -> BooleanType: ...
    
    @overload
    def WriteMessageEvent(self, eventMessage: StringType) -> BooleanType: ...
    
    def WriteTransferEvent(self, eventDescriptor: EventDescriptor, relatedActivityId: Guid, eventPayload: ArrayType[ObjectType]) -> Tuple[BooleanType, EventDescriptor]: ...
