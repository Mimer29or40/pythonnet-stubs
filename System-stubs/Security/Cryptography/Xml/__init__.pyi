...
from System import Array, Boolean, Byte, Enum, Exception, Func, ICloneable, IDisposable, Int32, Object, String, Type, ValueType, Void
from System.Collections import ArrayList, Hashtable, ICollection, IComparer, IEnumerable, IEnumerator, IList
from System.Collections.ObjectModel import Collection
from System.IO import Stream
from System.Runtime.InteropServices import _Exception
from System.Runtime.Serialization import ISerializable
from System.Security import ManifestKinds
from System.Security.Cryptography import AsymmetricAlgorithm, CipherMode, DSA, HashAlgorithm, KeyedHashAlgorithm, ManifestSignatureInformation, PaddingMode, RSA, SymmetricAlgorithm
from System.Security.Cryptography.X509Certificates import X509Certificate, X509Certificate2, X509IncludeOption, X509RevocationFlag, X509RevocationMode
from System.Security.Policy import Evidence
from System.Text import Encoding, StringBuilder
from System.Xml import XmlAttribute, XmlCDataSection, XmlComment, XmlDocument, XmlElement, XmlEntityReference, XmlException, XmlNode, XmlNodeList, XmlProcessingInstruction, XmlResolver, XmlSignificantWhitespace, XmlText, XmlWhitespace
...
class CanonicalXmlAttribute(XmlAttribute, ICloneable, IEnumerable, IXPathNavigable, ICanonicalizableNode):
    # No Fields
    
    # ---------- Constructors ---------- #
    
    def __init__(self, prefix: StringType, localName: StringType, namespaceURI: StringType, doc: XmlDocument, defaultNodeSetInclusionState: BooleanType): ...
    ...
    def Write(self, strBuilder: StringBuilder, docPos: DocPosition, anc: AncestralNamespaceContextManager) -> VoidType: ...
    
    def WriteHash(self, hash: HashAlgorithm, docPos: DocPosition, anc: AncestralNamespaceContextManager) -> VoidType: ...
...
class CanonicalXmlCDataSection(XmlCDataSection, ICloneable, IEnumerable, IXPathNavigable, ICanonicalizableNode):
    # No Fields
    
    # ---------- Constructors ---------- #
    
    def __init__(self, data: StringType, doc: XmlDocument, defaultNodeSetInclusionState: BooleanType): ...
...
class CanonicalXmlComment(XmlComment, ICloneable, IEnumerable, IXPathNavigable, ICanonicalizableNode):
    # No Fields
    
    # ---------- Constructors ---------- #
    
    def __init__(self, comment: StringType, doc: XmlDocument, defaultNodeSetInclusionState: BooleanType, includeComments: BooleanType): ...
...
class CanonicalXmlDocument(XmlDocument, ICloneable, IEnumerable, IXPathNavigable, ICanonicalizableNode):
    # No Fields
...
class CanonicalXmlElement(XmlElement, ICloneable, IEnumerable, IXPathNavigable, ICanonicalizableNode):
    # No Fields
...
class CanonicalXmlEntityReference(XmlEntityReference, ICloneable, IEnumerable, IXPathNavigable, ICanonicalizableNode):
    # No Fields
    
    # ---------- Constructors ---------- #
    
    def __init__(self, name: StringType, doc: XmlDocument, defaultNodeSetInclusionState: BooleanType): ...
...
class CanonicalXmlProcessingInstruction(XmlProcessingInstruction, ICloneable, IEnumerable, IXPathNavigable, ICanonicalizableNode):
    # No Fields
    
    # ---------- Constructors ---------- #
    
    def __init__(self, target: StringType, data: StringType, doc: XmlDocument, defaultNodeSetInclusionState: BooleanType): ...
...
class CanonicalXmlSignificantWhitespace(XmlSignificantWhitespace, ICloneable, IEnumerable, IXPathNavigable, ICanonicalizableNode):
    # No Fields
    
    # ---------- Constructors ---------- #
    
    def __init__(self, strData: StringType, doc: XmlDocument, defaultNodeSetInclusionState: BooleanType): ...
...
class CanonicalXmlWhitespace(XmlWhitespace, ICloneable, IEnumerable, IXPathNavigable, ICanonicalizableNode):
    # No Fields
...
class CanonicalizationDispatcher(ObjectType):
    ...
    @staticmethod
    def Write(node: XmlNode, strBuilder: StringBuilder, docPos: DocPosition, anc: AncestralNamespaceContextManager) -> VoidType: ...
    
    @staticmethod
    def WriteGenericNode(node: XmlNode, strBuilder: StringBuilder, docPos: DocPosition, anc: AncestralNamespaceContextManager) -> VoidType: ...
    
    @staticmethod
    def WriteHash(node: XmlNode, hash: HashAlgorithm, docPos: DocPosition, anc: AncestralNamespaceContextManager) -> VoidType: ...
    
    @staticmethod
    def WriteHashGenericNode(node: XmlNode, hash: HashAlgorithm, docPos: DocPosition, anc: AncestralNamespaceContextManager) -> VoidType: ...
...
class DataObject(ObjectType):
    ...
    @overload
    def __init__(self, id: StringType, mimeType: StringType, encoding: StringType, data: XmlElement): ...
...
class EncryptedXml(ObjectType):
    ...
    def DecryptData(self, encryptedData: EncryptedData, symmetricAlgorithm: SymmetricAlgorithm) -> ArrayType[ByteType]: ...
    ...
    @staticmethod
    @overload
    def DecryptKey(keyData: ArrayType[ByteType], symmetricAlgorithm: SymmetricAlgorithm) -> ArrayType[ByteType]: ...
    
    @staticmethod
    @overload
    def DecryptKey(keyData: ArrayType[ByteType], rsa: RSA, useOAEP: BooleanType) -> ArrayType[ByteType]: ...
    ...
    @overload
    def EncryptData(self, plaintext: ArrayType[ByteType], symmetricAlgorithm: SymmetricAlgorithm) -> ArrayType[ByteType]: ...
    
    @overload
    def EncryptData(self, inputElement: XmlElement, symmetricAlgorithm: SymmetricAlgorithm, content: BooleanType) -> ArrayType[ByteType]: ...
    
    @staticmethod
    @overload
    def EncryptKey(keyData: ArrayType[ByteType], symmetricAlgorithm: SymmetricAlgorithm) -> ArrayType[ByteType]: ...
    
    @staticmethod
    @overload
    def EncryptKey(keyData: ArrayType[ByteType], rsa: RSA, useOAEP: BooleanType) -> ArrayType[ByteType]: ...
    
    def GetDecryptionIV(self, encryptedData: EncryptedData, symmetricAlgorithmUri: StringType) -> ArrayType[ByteType]: ...
    ...
    def ReplaceData(self, inputElement: XmlElement, decryptedData: ArrayType[ByteType]) -> VoidType: ...
    
    @staticmethod
    def ReplaceElement(inputElement: XmlElement, encryptedData: EncryptedData, content: BooleanType) -> VoidType: ...
...
class SignedXml(ObjectType):
    ...
    @overload
    def CheckSignature(self, certificate: X509Certificate2, verifySignatureOnly: BooleanType) -> BooleanType: ...
    
    def CheckSignatureReturningKey(self, signingKey: AsymmetricAlgorithm) -> Tuple[BooleanType, AsymmetricAlgorithm]: ...
