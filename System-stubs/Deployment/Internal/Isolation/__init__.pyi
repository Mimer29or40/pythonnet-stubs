...
from System import Array, Boolean, Byte, Char, DateTime, Enum, Guid, IDisposable, Int32, Int64, IntPtr, Object, String, UInt16, UInt32, UInt64, UIntPtr, ValueType, Void
...
class IsolationInterop(ABC, ObjectType):
    ...
    def SXS_INSTALL_REFERENCE_SCHEME_SXS_STRONGNAME_SIGNED_PRIVATE_ASSEMBLY(value: Guid) -> None: ...
...
class Store(ObjectType):
    ...
    def BindReferenceToAssemblyIdentity(self, Flags: UIntType, ReferenceIdentity: IReferenceIdentity, cDeploymentsToIgnore: UIntType, DefinitionIdentity_DeploymentsToIgnore: ArrayType[IDefinitionIdentity]) -> IDefinitionIdentity: ...
    
    def BindReferenceToAssemblyManifest(self, Flags: UIntType, ReferenceIdentity: IReferenceIdentity, cDeploymentsToIgnore: UIntType, DefinitionIdentity_DeploymentsToIgnore: ArrayType[IDefinitionIdentity]) -> ICMS: ...
    
    def CalculateDelimiterOfDeploymentsBasedOnQuota(self, dwFlags: UIntType, cDeployments: UIntType, rgpIDefinitionAppId_Deployments: ArrayType[IDefinitionAppId], InstallerReference: StoreApplicationReference, ulonglongQuota: ULongType, Delimiter: UIntType, SizeSharedWithExternalDeployment: ULongType, SizeConsumedByInputDeploymentArray: ULongType) -> Tuple[VoidType, StoreApplicationReference, UIntType, ULongType, ULongType]: ...
    
    @overload
    def EnumAssemblies(self, Flags: EnumAssembliesFlags) -> StoreAssemblyEnumeration: ...
    
    @overload
    def EnumAssemblies(self, Flags: EnumAssembliesFlags, refToMatch: IReferenceIdentity) -> StoreAssemblyEnumeration: ...
    
    def EnumCategories(self, Flags: EnumCategoriesFlags, CategoryMatch: IReferenceIdentity) -> StoreCategoryEnumeration: ...
    
    def EnumCategoryInstances(self, Flags: EnumCategoryInstancesFlags, Category: IDefinitionIdentity, SubCat: StringType) -> StoreCategoryInstanceEnumeration: ...
    
    def EnumFiles(self, Flags: EnumAssemblyFilesFlags, Assembly: IDefinitionIdentity) -> StoreAssemblyFileEnumeration: ...
    
    def EnumInstallationReferences(self, Flags: EnumAssemblyInstallReferenceFlags, Assembly: IDefinitionIdentity) -> IEnumSTORE_ASSEMBLY_INSTALLATION_REFERENCE: ...
    
    def EnumInstallerDeploymentProperties(self, InstallerId: Guid, InstallerName: StringType, InstallerMetadata: StringType, Deployment: IDefinitionAppId) -> StoreDeploymentMetadataPropertyEnumeration: ...
    
    def EnumInstallerDeployments(self, InstallerId: Guid, InstallerName: StringType, InstallerMetadata: StringType, DeploymentFilter: IReferenceAppId) -> StoreDeploymentMetadataEnumeration: ...
    
    def EnumPrivateFiles(self, Flags: EnumApplicationPrivateFiles, Application: IDefinitionAppId, Assembly: IDefinitionIdentity) -> StoreAssemblyFileEnumeration: ...
    
    @overload
    def EnumSubcategories(self, Flags: EnumSubcategoriesFlags, CategoryMatch: IDefinitionIdentity) -> StoreSubcategoryEnumeration: ...
    
    @overload
    def EnumSubcategories(self, Flags: EnumSubcategoriesFlags, Category: IDefinitionIdentity, SearchPattern: StringType) -> StoreSubcategoryEnumeration: ...
    
    def GetAssemblyIdentity(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity) -> IDefinitionIdentity: ...
    
    def GetAssemblyManifest(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity) -> ICMS: ...
    
    def GetDeploymentProperty(self, Flags: GetPackagePropertyFlags, Deployment: IDefinitionAppId, Reference: StoreApplicationReference, PropertySet: Guid, PropertyName: StringType) -> ArrayType[ByteType]: ...
...
class StoreOperationInstallDeployment(ValueType):
    ...
    @overload
    def __init__(self, App: IDefinitionAppId, UninstallOthers: BooleanType, reference: StoreApplicationReference): ...
...
class StoreOperationScavenge(ValueType):
    ...
    @overload
    def __init__(self, Light: BooleanType, SizeLimit: ULongType, RunLimit: ULongType, ComponentLimit: UIntType): ...
...
class StoreOperationSetDeploymentMetadata(ValueType):
    ...
    @overload
    def __init__(self, Deployment: IDefinitionAppId, Reference: StoreApplicationReference, SetProperties: ArrayType[StoreOperationMetadataProperty]): ...
    
    @overload
    def __init__(self, Deployment: IDefinitionAppId, Reference: StoreApplicationReference, SetProperties: ArrayType[StoreOperationMetadataProperty], TestProperties: ArrayType[StoreOperationMetadataProperty]): ...
...
class StoreOperationStageComponentFile(ValueType):
    ...
    @overload
    def __init__(self, App: IDefinitionAppId, Component: IDefinitionIdentity, CompRelPath: StringType, SrcFile: StringType): ...
...
class IActContext(Protocol):
    ...
    def ApplicationBasePath(self, Flags: UIntType, ApplicationPath: StringType) -> Tuple[VoidType, StringType]: ...
    
    def CreateActContextFromCategoryInstance(self, dwFlags: UIntType, CategoryInstance: CATEGORY_INSTANCE, ppCreatedAppContext: ObjectType) -> Tuple[VoidType, CATEGORY_INSTANCE, ObjectType]: ...
    
    def EnumCategories(self, Flags: UIntType, CategoryToMatch: IReferenceIdentity, riid: Guid, EnumOut: ObjectType) -> Tuple[VoidType, Guid, ObjectType]: ...
    
    def EnumCategoryInstances(self, Flags: UIntType, CategoryId: IDefinitionIdentity, Subcategory: StringType, riid: Guid, EnumOut: ObjectType) -> Tuple[VoidType, Guid, ObjectType]: ...
    
    def EnumComponents(self, dwFlags: UIntType, ppIdentityEnum: ObjectType) -> Tuple[VoidType, ObjectType]: ...
    
    def EnumSubcategories(self, Flags: UIntType, CategoryId: IDefinitionIdentity, SubcategoryPattern: StringType, riid: Guid, EnumOut: ObjectType) -> Tuple[VoidType, Guid, ObjectType]: ...
    
    def FindComponentsByDefinition(self, dwFlags: UIntType, ComponentCount: NUIntType, Components: ArrayType[IDefinitionIdentity], Indicies: ArrayType[NUIntType], Dispositions: ArrayType[UIntType]) -> Tuple[VoidType, ArrayType[NUIntType], ArrayType[UIntType]]: ...
    
    def FindComponentsByReference(self, dwFlags: UIntType, Components: NUIntType, References: ArrayType[IReferenceIdentity], Indicies: ArrayType[NUIntType], Dispositions: ArrayType[UIntType]) -> Tuple[VoidType, ArrayType[NUIntType], ArrayType[UIntType]]: ...
    
    def FindReferenceInContext(self, dwFlags: UIntType, Reference: IReferenceIdentity, MatchedDefinition: ObjectType) -> Tuple[VoidType, ObjectType]: ...
    
    def GetAppId(self, AppId: ObjectType) -> Tuple[VoidType, ObjectType]: ...
    
    def GetApplicationProperties(self, Flags: UIntType, cProperties: NUIntType, PropertyNames: ArrayType[StringType], PropertyValues: StringType, ComponentIndicies: NUIntType) -> Tuple[VoidType, StringType, NUIntType]: ...
    
    def GetApplicationStateFilesystemLocation(self, dwFlags: UIntType, Component: NUIntType, pCoordinateList: NIntType, ppszPath: StringType) -> Tuple[VoidType, StringType]: ...
    
    def GetComponentManifest(self, Flags: UIntType, ComponentId: IDefinitionIdentity, riid: Guid, ManifestInteface: ObjectType) -> Tuple[VoidType, Guid, ObjectType]: ...
    
    def GetComponentPayloadPath(self, Flags: UIntType, ComponentId: IDefinitionIdentity, PayloadPath: StringType) -> Tuple[VoidType, StringType]: ...
    
    def GetComponentStringTableStrings(self, Flags: UIntType, ComponentIndex: NIntType, StringCount: NIntType, SourceStrings: ArrayType[StringType], DestinationStrings: StringType, CultureFallbacks: NIntType) -> Tuple[VoidType, ArrayType[StringType], StringType]: ...
    
    def PrepareForExecution(self, Inputs: NIntType, Outputs: NIntType) -> VoidType: ...
    
    def ReplaceStringMacros(self, Flags: UIntType, Culture: StringType, ReplacementPattern: StringType, Replaced: StringType) -> Tuple[VoidType, StringType]: ...
    
    def SetApplicationRunningState(self, dwFlags: UIntType, ulState: UIntType, ulDisposition: UIntType) -> Tuple[VoidType, UIntType]: ...
...
class IAppIdAuthority(Protocol):
    ...
    def AreDefinitionsEqual(self, Flags: UIntType, Definition1: IDefinitionAppId, Definition2: IDefinitionAppId) -> BooleanType: ...
    
    def AreReferencesEqual(self, Flags: UIntType, Reference1: IReferenceAppId, Reference2: IReferenceAppId) -> BooleanType: ...
    
    def AreTextualDefinitionsEqual(self, Flags: UIntType, AppIdLeft: StringType, AppIdRight: StringType) -> BooleanType: ...
    
    def AreTextualReferencesEqual(self, Flags: UIntType, AppIdLeft: StringType, AppIdRight: StringType) -> BooleanType: ...
    
    def CreateDefinition(self) -> IDefinitionAppId: ...
    
    def CreateReference(self) -> IReferenceAppId: ...
    
    def DefinitionToText(self, Flags: UIntType, DefinitionAppId: IDefinitionAppId) -> StringType: ...
    
    def DoesDefinitionMatchReference(self, Flags: UIntType, DefinitionIdentity: IDefinitionAppId, ReferenceIdentity: IReferenceAppId) -> BooleanType: ...
    
    def DoesTextualDefinitionMatchTextualReference(self, Flags: UIntType, Definition: StringType, Reference: StringType) -> BooleanType: ...
    
    def GenerateDefinitionKey(self, Flags: UIntType, DefinitionIdentity: IDefinitionAppId) -> StringType: ...
    
    def GenerateReferenceKey(self, Flags: UIntType, ReferenceIdentity: IReferenceAppId) -> StringType: ...
    
    def HashDefinition(self, Flags: UIntType, DefinitionIdentity: IDefinitionAppId) -> ULongType: ...
...
class IDefinitionAppId(Protocol):
    ...
    def SetAppPath(self, cIDefinitionIdentity: UIntType, DefinitionIdentity: ArrayType[IDefinitionIdentity]) -> VoidType: ...
...
class IDefinitionIdentity(Protocol):
    ...
    def Clone(self, cDeltas: NIntType, Deltas: ArrayType[IDENTITY_ATTRIBUTE]) -> IDefinitionIdentity: ...
    
    def EnumAttributes(self) -> IEnumIDENTITY_ATTRIBUTE: ...
    
    def GetAttribute(self, Namespace: StringType, Name: StringType) -> StringType: ...
    
    def SetAttribute(self, Namespace: StringType, Name: StringType, Value: StringType) -> VoidType: ...
...
class IEnumDefinitionIdentity(Protocol):
    ...
    def Next(self, celt: UIntType, DefinitionIdentity: ArrayType[IDefinitionIdentity]) -> Tuple[UIntType, ArrayType[IDefinitionIdentity]]: ...
...
class IEnumIDENTITY_ATTRIBUTE(Protocol):
    ...
    def CurrentIntoBuffer(self, Available: NIntType, Data: ArrayType[ByteType]) -> Tuple[NIntType, ArrayType[ByteType]]: ...
    
    def Next(self, celt: UIntType, rgAttributes: ArrayType[IDENTITY_ATTRIBUTE]) -> Tuple[UIntType, ArrayType[IDENTITY_ATTRIBUTE]]: ...
...
class IEnumReferenceIdentity(Protocol):
    ...
    def Next(self, celt: UIntType, ReferenceIdentity: ArrayType[IReferenceIdentity]) -> Tuple[UIntType, ArrayType[IReferenceIdentity]]: ...
...
class IEnumSTORE_ASSEMBLY(Protocol):
    ...
    def Next(self, celt: UIntType, rgelt: ArrayType[STORE_ASSEMBLY]) -> Tuple[UIntType, ArrayType[STORE_ASSEMBLY]]: ...
...
class IEnumSTORE_ASSEMBLY_FILE(Protocol):
    ...
    def Next(self, celt: UIntType, rgelt: ArrayType[STORE_ASSEMBLY_FILE]) -> Tuple[UIntType, ArrayType[STORE_ASSEMBLY_FILE]]: ...
...
class IEnumSTORE_ASSEMBLY_INSTALLATION_REFERENCE(Protocol):
    ...
    def Next(self, celt: UIntType, rgelt: ArrayType[StoreApplicationReference]) -> Tuple[UIntType, ArrayType[StoreApplicationReference]]: ...
...
class IEnumSTORE_CATEGORY(Protocol):
    ...
    def Next(self, celt: UIntType, rgElements: ArrayType[STORE_CATEGORY]) -> Tuple[UIntType, ArrayType[STORE_CATEGORY]]: ...
...
class IEnumSTORE_CATEGORY_INSTANCE(Protocol):
    ...
    def Next(self, ulElements: UIntType, rgInstances: ArrayType[STORE_CATEGORY_INSTANCE]) -> Tuple[UIntType, ArrayType[STORE_CATEGORY_INSTANCE]]: ...
...
class IEnumSTORE_CATEGORY_SUBCATEGORY(Protocol):
    ...
    def Next(self, celt: UIntType, rgElements: ArrayType[STORE_CATEGORY_SUBCATEGORY]) -> Tuple[UIntType, ArrayType[STORE_CATEGORY_SUBCATEGORY]]: ...
...
class IEnumSTORE_DEPLOYMENT_METADATA(Protocol):
    ...
    def Next(self, celt: UIntType, AppIds: ArrayType[IDefinitionAppId]) -> Tuple[UIntType, ArrayType[IDefinitionAppId]]: ...
...
class IEnumSTORE_DEPLOYMENT_METADATA_PROPERTY(Protocol):
    ...
    def Next(self, celt: UIntType, AppIds: ArrayType[StoreOperationMetadataProperty]) -> Tuple[UIntType, ArrayType[StoreOperationMetadataProperty]]: ...
...
class IEnumUnknown(Protocol):
    ...
    def Next(self, celt: UIntType, rgelt: ArrayType[ObjectType], celtFetched: UIntType) -> Tuple[IntType, ArrayType[ObjectType], UIntType]: ...
...
class IIdentityAuthority(Protocol):
    ...
    def AreDefinitionsEqual(self, Flags: UIntType, Definition1: IDefinitionIdentity, Definition2: IDefinitionIdentity) -> BooleanType: ...
    
    def AreReferencesEqual(self, Flags: UIntType, Reference1: IReferenceIdentity, Reference2: IReferenceIdentity) -> BooleanType: ...
    
    def AreTextualDefinitionsEqual(self, Flags: UIntType, IdentityLeft: StringType, IdentityRight: StringType) -> BooleanType: ...
    
    def AreTextualReferencesEqual(self, Flags: UIntType, IdentityLeft: StringType, IdentityRight: StringType) -> BooleanType: ...
    
    def CreateDefinition(self) -> IDefinitionIdentity: ...
    
    def CreateReference(self) -> IReferenceIdentity: ...
    
    def DefinitionToText(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity) -> StringType: ...
    
    def DefinitionToTextBuffer(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity, BufferSize: UIntType, Buffer: ArrayType[CharType]) -> Tuple[UIntType, ArrayType[CharType]]: ...
    
    def DoesDefinitionMatchReference(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity, ReferenceIdentity: IReferenceIdentity) -> BooleanType: ...
    
    def DoesTextualDefinitionMatchTextualReference(self, Flags: UIntType, Definition: StringType, Reference: StringType) -> BooleanType: ...
    
    def GenerateDefinitionKey(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity) -> StringType: ...
    
    def GenerateReferenceKey(self, Flags: UIntType, ReferenceIdentity: IReferenceIdentity) -> StringType: ...
    
    def HashDefinition(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity) -> ULongType: ...
    
    def HashReference(self, Flags: UIntType, ReferenceIdentity: IReferenceIdentity) -> ULongType: ...
    
    def ReferenceToText(self, Flags: UIntType, ReferenceIdentity: IReferenceIdentity) -> StringType: ...
    
    def ReferenceToTextBuffer(self, Flags: UIntType, ReferenceIdentity: IReferenceIdentity, BufferSize: UIntType, Buffer: ArrayType[CharType]) -> Tuple[UIntType, ArrayType[CharType]]: ...
...
class IManifestParseErrorCallback(Protocol):
    ...
    def OnError(self, StartLine: UIntType, nStartColumn: UIntType, cCharacterCount: UIntType, hr: IntType, ErrorStatusHostFile: StringType, ParameterCount: UIntType, Parameters: ArrayType[StringType]) -> VoidType: ...
...
class IReferenceIdentity(Protocol):
    ...
    def Clone(self, cDeltas: NIntType, Deltas: ArrayType[IDENTITY_ATTRIBUTE]) -> IReferenceIdentity: ...
...
class ISectionWithReferenceIdentityKey(Protocol):
    ...
    def Lookup(self, ReferenceIdentityKey: IReferenceIdentity, ppUnknown: ObjectType) -> Tuple[VoidType, ObjectType]: ...
...
class ISectionWithStringKey(Protocol):
    ...
    def Lookup(self, wzStringKey: StringType, ppUnknown: ObjectType) -> Tuple[VoidType, ObjectType]: ...
...
class IStateManager(Protocol):
    ...
    def GetApplicationStateFilesystemLocation(self, Flags: UIntType, Appidentity: IDefinitionAppId, ComponentIdentity: IDefinitionIdentity, Coordinates: NUIntType, Path: StringType) -> Tuple[VoidType, StringType]: ...
    
    def PrepareApplicationState(self, Inputs: NUIntType, Outputs: NUIntType) -> Tuple[VoidType, NUIntType]: ...
    
    def Scavenge(self, Flags: UIntType, Disposition: UIntType) -> Tuple[VoidType, UIntType]: ...
    
    def SetApplicationRunningState(self, Flags: UIntType, Context: IActContext, RunningState: UIntType, Disposition: UIntType) -> Tuple[VoidType, UIntType]: ...
...
class IStore(Protocol):
    ...
    def BindDefinitions(self, Flags: UIntType, Count: NIntType, DefsToBind: ArrayType[IDefinitionIdentity], DeploymentsToIgnore: UIntType, DefsToIgnore: ArrayType[IDefinitionIdentity]) -> NIntType: ...
    
    def BindReferenceToAssembly(self, Flags: UIntType, ReferenceIdentity: IReferenceIdentity, cDeploymentsToIgnore: UIntType, DefinitionIdentity_DeploymentsToIgnore: ArrayType[IDefinitionIdentity], riid: Guid) -> Tuple[ObjectType, Guid]: ...
    
    def CalculateDelimiterOfDeploymentsBasedOnQuota(self, dwFlags: UIntType, cDeployments: NIntType, rgpIDefinitionAppId_Deployments: ArrayType[IDefinitionAppId], InstallerReference: StoreApplicationReference, ulonglongQuota: ULongType, Delimiter: NIntType, SizeSharedWithExternalDeployment: ULongType, SizeConsumedByInputDeploymentArray: ULongType) -> Tuple[VoidType, StoreApplicationReference, NIntType, ULongType, ULongType]: ...
    
    def EnumAssemblies(self, Flags: UIntType, ReferenceIdentity_ToMatch: IReferenceIdentity, riid: Guid) -> Tuple[ObjectType, Guid]: ...
    
    def EnumCategories(self, Flags: UIntType, ReferenceIdentity_ToMatch: IReferenceIdentity, riid: Guid) -> Tuple[ObjectType, Guid]: ...
    
    def EnumCategoryInstances(self, Flags: UIntType, CategoryId: IDefinitionIdentity, SubcategoryPath: StringType, riid: Guid) -> Tuple[ObjectType, Guid]: ...
    
    def EnumFiles(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity, riid: Guid) -> Tuple[ObjectType, Guid]: ...
    
    def EnumInstallationReferences(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity, riid: Guid) -> Tuple[ObjectType, Guid]: ...
    
    def EnumInstallerDeploymentMetadata(self, Flags: UIntType, Reference: StoreApplicationReference, Filter: IReferenceAppId, riid: Guid) -> Tuple[ObjectType, StoreApplicationReference, Guid]: ...
    
    def EnumInstallerDeploymentMetadataProperties(self, Flags: UIntType, Reference: StoreApplicationReference, Filter: IDefinitionAppId, riid: Guid) -> Tuple[ObjectType, StoreApplicationReference, Guid]: ...
    
    def EnumPrivateFiles(self, Flags: UIntType, Application: IDefinitionAppId, DefinitionIdentity: IDefinitionIdentity, riid: Guid) -> Tuple[ObjectType, Guid]: ...
    
    def EnumSubcategories(self, Flags: UIntType, CategoryId: IDefinitionIdentity, SubcategoryPathPattern: StringType, riid: Guid) -> Tuple[ObjectType, Guid]: ...
    
    def GetAssemblyInformation(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity, riid: Guid) -> Tuple[ObjectType, Guid]: ...
    
    def GetDeploymentProperty(self, Flags: UIntType, DeploymentInPackage: IDefinitionAppId, Reference: StoreApplicationReference, PropertySet: Guid, pcwszPropertyName: StringType, blob: BLOB) -> Tuple[VoidType, StoreApplicationReference, Guid, BLOB]: ...
    
    def LockApplicationPath(self, Flags: UIntType, ApId: IDefinitionAppId, Cookie: NIntType) -> Tuple[StringType, NIntType]: ...
    
    def LockAssemblyPath(self, Flags: UIntType, DefinitionIdentity: IDefinitionIdentity, Cookie: NIntType) -> Tuple[StringType, NIntType]: ...
    ...
    def Transact(self, cOperation: NIntType, rgOperations: ArrayType[StoreTransactionOperation], rgDispositions: ArrayType[UIntType], rgResults: ArrayType[IntType]) -> Tuple[VoidType, ArrayType[UIntType], ArrayType[IntType]]: ...
