...
from System import Array, Boolean, Byte, Func, IDisposable, Int32, Object, String, ValueType, Void
from System.Security.Cryptography import CipherMode, CngKey, CngKeyOpenOptions, CngProvider, CryptographicException, ICryptoTransform, KeySizes, PaddingMode
...
class BasicSymmetricCipher(ABC, ObjectType, IDisposable):
    ...
    def Transform(self, input: ArrayType[ByteType], inputOffset: IntType, count: IntType, output: ArrayType[ByteType], outputOffset: IntType) -> IntType: ...
    
    def TransformFinal(self, input: ArrayType[ByteType], inputOffset: IntType, count: IntType) -> ArrayType[ByteType]: ...
...
class BasicSymmetricCipherBCrypt(BasicSymmetricCipher, IDisposable):
    ...
    def __init__(self, algorithm: SafeBCryptAlgorithmHandle, cipherMode: CipherMode, blockSizeInBytes: IntType, key: ArrayType[ByteType], iv: ArrayType[ByteType], encrypting: BooleanType): ...
...
class BasicSymmetricCipherNCrypt(BasicSymmetricCipher, IDisposable):
    ...
    def __init__(self, cngKeyFactory: Func[CngKey], cipherMode: CipherMode, blockSizeInBytes: IntType, iv: ArrayType[ByteType], encrypting: BooleanType): ...
...
class SymmetricImportExportExtensions(ABC, ObjectType):
    ...
    @staticmethod
    def GetSymmetricKeyDataIfExportable(cngKey: CngKey, algorithm: StringType) -> ArrayType[ByteType]: ...
...
class UniversalCryptoTransform(ABC, ObjectType, ICryptoTransform, IDisposable):
    ...
    @staticmethod
    def Create(paddingMode: PaddingMode, cipher: BasicSymmetricCipher, encrypting: BooleanType) -> ICryptoTransform: ...
...
class CngSymmetricAlgorithmCore(ValueType):
    ...
    @overload
    def __init__(self, outer: ICngSymmetricAlgorithm, keyName: StringType, provider: CngProvider, openOptions: CngKeyOpenOptions): ...
